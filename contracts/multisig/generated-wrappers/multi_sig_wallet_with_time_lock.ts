...
export type MultiSigWalletWithTimeLockEventArgs =
    | MultiSigWalletWithTimeLockConfirmationTimeSetEventArgs
    | MultiSigWalletWithTimeLockTimeLockChangeEventArgs
    | MultiSigWalletWithTimeLockConfirmationEventArgs
    | MultiSigWalletWithTimeLockRevocationEventArgs
    | MultiSigWalletWithTimeLockSubmissionEventArgs
    | MultiSigWalletWithTimeLockExecutionEventArgs
    | MultiSigWalletWithTimeLockExecutionFailureEventArgs
    | MultiSigWalletWithTimeLockDepositEventArgs
    | MultiSigWalletWithTimeLockOwnerAdditionEventArgs
    | MultiSigWalletWithTimeLockOwnerRemovalEventArgs
    | MultiSigWalletWithTimeLockRequirementChangeEventArgs;

export enum MultiSigWalletWithTimeLockEvents {
...
export interface MultiSigWalletWithTimeLockConfirmationTimeSetEventArgs extends DecodedLogArgs {
    transactionId: BigNumber;
    confirmationTime: BigNumber;
}

export interface MultiSigWalletWithTimeLockTimeLockChangeEventArgs extends DecodedLogArgs {
    secondsTimeLocked: BigNumber;
}

export interface MultiSigWalletWithTimeLockConfirmationEventArgs extends DecodedLogArgs {
    sender: string;
    transactionId: BigNumber;
}

export interface MultiSigWalletWithTimeLockRevocationEventArgs extends DecodedLogArgs {
    sender: string;
    transactionId: BigNumber;
}

export interface MultiSigWalletWithTimeLockSubmissionEventArgs extends DecodedLogArgs {
    transactionId: BigNumber;
}

export interface MultiSigWalletWithTimeLockExecutionEventArgs extends DecodedLogArgs {
    transactionId: BigNumber;
}

export interface MultiSigWalletWithTimeLockExecutionFailureEventArgs extends DecodedLogArgs {
    transactionId: BigNumber;
}

export interface MultiSigWalletWithTimeLockDepositEventArgs extends DecodedLogArgs {
    sender: string;
    value: BigNumber;
}

export interface MultiSigWalletWithTimeLockOwnerAdditionEventArgs extends DecodedLogArgs {
    owner: string;
}

export interface MultiSigWalletWithTimeLockOwnerRemovalEventArgs extends DecodedLogArgs {
    owner: string;
}

export interface MultiSigWalletWithTimeLockRequirementChangeEventArgs extends DecodedLogArgs {
    required: BigNumber;
}
...
export class MultiSigWalletWithTimeLockContract extends BaseContract {
    public owners = {
        async callAsync(
            index_0: BigNumber,
            ...
            const self = (this as any) as MultiSigWalletWithTimeLockContract;
    ...
    public changeTimeLock = {
        async sendTransactionAsync(_secondsTimeLocked: BigNumber, txData: Partial<TxData> = {}): Promise<string> {
            ...
            const encodedData = self
                ...
                .functions.changeTimeLock.encode([_secondsTimeLocked]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                    to: self.address,
                    ...txData,
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        _required: BigNumber,
        _secondsTimeLocked: BigNumber,
    ): Promise<MultiSigWalletWithTimeLockContract> {
        if (_.isUndefined(artifact.compilerOutput)) {
            throw new Error('Compiler output not found in the artifact file');
        }
        const bytecode = artifact.compilerOutput.evm.bytecode.object;
        const abi = artifact.compilerOutput.abi;
        return MultiSigWalletWithTimeLockContract.deployAsync(
            bytecode,
            abi,
            provider,
            txDefaults,
    ...
    public static async deployAsync(
        ...
        [_owners, _required, _secondsTimeLocked] = BaseContract._formatABIDataItemList(
        ...
        const txData = deployInfo.encode(bytecode, [_owners, _required, _secondsTimeLocked]);
        ...
        logUtils.log(`MultiSigWalletWithTimeLock successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new MultiSigWalletWithTimeLockContract(
            abi,
            txReceipt.contractAddress as string,
            provider,
            txDefaults,
        );
        contractInstance.constructorArgs = [_owners, _required, _secondsTimeLocked];
        return contractInstance;
    }
    constructor(abi: ContractAbi, address: string, provider: Provider, txDefaults?: Partial<TxData>) {
        super('MultiSigWalletWithTimeLock', abi, address, provider, txDefaults);
