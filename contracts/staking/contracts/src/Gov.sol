// Fork of Comp token with token functionality stripped out
// and minting support added
...
contract Comp {
    ...
    event Burned(address indexed account, uint96 amount);

    /**
     * @notice Construct a new Comp token
     * @param _minter the contract which can mint or remove tokens
     */
    ...
    function _burn(address account, uint96 amount) internal {
        balances[account] = sub96(amount, balances[account], "Underflow");
