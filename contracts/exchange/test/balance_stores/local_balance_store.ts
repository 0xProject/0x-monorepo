    ...
    public async transferAssetAsync(
        ...
        switch (assetProxyId) {
            case AssetProxyId.ERC20: {
                ...
                const [proxyId, tokenAddress] = await this._devUtils.decodeERC20AssetData(assetData).callAsync();
            ...
            case AssetProxyId.ERC721: {
                // tslint:disable-next-line:no-unused-variable
                const [proxyId, tokenAddress, tokenId] = await this._devUtils
            ...
            case AssetProxyId.MultiAsset: {
                // tslint:disable-next-line:no-unused-variable
                const [proxyId, amounts, nestedAssetData] = await this._devUtils
