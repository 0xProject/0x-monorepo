...
//             const tx = transactionHelper.getResultAndReceiptAsync(testContract.batchFillOrders, orders, fillAmounts, signatures);
//             return expect(tx).to.revertWith(expectedError);
//         });
...
//     type MarketSellBuyContractFunction = () => MutatorContractFunction<[FillResults, ExpectedFillOrderCallArgs[]]>;
...
//                 );
//                 const tx = transactionHelper.getResultAndReceiptAsync(getContractFn, orders, takerAssetFillAmount, signatures);
//                 return expect(tx).to.revertWith(expectedError);
//             });
...
//                     makerAssetFillAmount,
//                 );
//                 const tx = transactionHelper.getResultAndReceiptAsync(getContractFn(), orders, makerAssetFillAmount, signatures);
//                 return expect(tx).to.revertWith(expectedError);
//             });
...
//             const [, receipt] = await transactionHelper.getResultAndReceiptAsync(testContract.batchCancelOrders, orders);
