...
import {
    TestPlasmaswapBridgeContract,
    TestPlasmaswapBridgeEvents as ContractEvents,
    TestPlasmaswapBridgeSwapExactTokensForTokensInputEventArgs as SwapExactTokensForTokensArgs,
    TestPlasmaswapBridgeTokenApproveEventArgs as TokenApproveArgs,
    TestPlasmaswapBridgeTokenTransferEventArgs as TokenTransferArgs,
} from './wrappers';

blockchainTests.resets('Plasmaswap unit tests', env => {
    ...
    let testContract: TestPlasmaswapBridgeContract;

    before(async () => {
        testContract = await TestPlasmaswapBridgeContract.deployFrom0xArtifactAsync(
            artifacts.TestPlasmaswapBridge,
            env.provider,
            env.txDefaults,
            artifacts,
        );
    ...
    describe('bridgeTransferFrom()', () => {
        ...
        describe('token -> token', async () => {
            it('calls PlasmaswapRouter.swapExactTokensForTokens()', async () => {
