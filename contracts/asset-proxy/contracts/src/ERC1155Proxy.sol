    ...
    MixinAuthorizable
{
        ...
        external
    {
        ...
        //       real-time.
        //
        // (***): this proxy multiplies each entry in the `values` array by a scalar;
        //        the scaled entries are stored in a separate array, `scaledValues`,
        //        in case `ids` or `data` resolves to the same entry as `values`.
        //        This is an abi-encoder optimization can occur if, for example,
        //        the ids of the assets being traded is the same as the values.
        //
