...
export class LibAssetDataContract extends BaseContract {
    public decodeERC721AssetData = {
        ...
        > {
            ...
            const self = this as any as LibAssetDataContract;
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return LibAssetDataContract.deployAsync(bytecode, abi, provider, txDefaults, _exchange
);
    }
    public static async deployAsync(
        ...
        logUtils.log(`LibAssetData successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new LibAssetDataContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
        contractInstance.constructorArgs = [_exchange
];
        return contractInstance;
    }
    constructor(abi: ContractAbi, address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('LibAssetData', abi, address, supportedProvider, txDefaults);
