...
export type DummyMultipleReturnERC20TokenEventArgs =
    | DummyMultipleReturnERC20TokenTransferEventArgs
    | DummyMultipleReturnERC20TokenApprovalEventArgs;

export enum DummyMultipleReturnERC20TokenEvents {
    Transfer = 'Transfer',
    Approval = 'Approval',
}
...
export class DummyMultipleReturnERC20TokenContract extends BaseContract {
    public name = {
        async callAsync(
        ...
        > {
            const self = this as any as DummyMultipleReturnERC20TokenContract;
    ...
    ): Promise<DummyMultipleReturnERC20TokenContract> {
        if (_.isUndefined(artifact.compilerOutput)) {
            throw new Error('Compiler output not found in the artifact file');
        }
        const bytecode = artifact.compilerOutput.evm.bytecode.object;
        const abi = artifact.compilerOutput.abi;
        return DummyMultipleReturnERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults, _name,
_symbol,
_decimals,
_totalSupply
);
...
_totalSupply
        ...
        logUtils.log(`DummyMultipleReturnERC20Token successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new DummyMultipleReturnERC20TokenContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
...
_totalSupply
    ...
    constructor(abi: ContractAbi, address: string, provider: Provider, txDefaults?: Partial<TxData>) {
        super('DummyMultipleReturnERC20Token', abi, address, provider, txDefaults);
