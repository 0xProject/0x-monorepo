...
export type TestExchangeInternalsEventArgs =
    | TestExchangeInternalsSignatureValidatorApprovalEventArgs
    | TestExchangeInternalsFillEventArgs
    | TestExchangeInternalsCancelEventArgs
    | TestExchangeInternalsCancelUpToEventArgs
    | TestExchangeInternalsAssetProxyRegisteredEventArgs;

export enum TestExchangeInternalsEvents {
...
export class TestExchangeInternalsContract extends BaseContract {
    ...
    public publicUpdateFilledState = {
        async sendTransactionAsync(
            ...
            const self = this as any as TestExchangeInternalsContract;
            const inputAbi = self._lookupAbi('publicUpdateFilledState({address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes},address,bytes32,uint256,{uint256,uint256,uint256,uint256})').inputs;
            [order,
    takerAddress,
    orderHash,
    ...
    fillResults
            ...
            const encodedData = self._lookupEthersInterface('publicUpdateFilledState({address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes},address,bytes32,uint256,{uint256,uint256,uint256,uint256})').functions.publicUpdateFilledState.encode([order,
    takerAddress,
    orderHash,
    orderTakerAssetFilledAmount,
    fillResults
    ...
    fillResults
            ...
            const abiEncodedTransactionData = self._lookupEthersInterface('publicUpdateFilledState({address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes},address,bytes32,uint256,{uint256,uint256,uint256,uint256})').functions.publicUpdateFilledState.encode([order,
    takerAddress,
    orderHash,
    orderTakerAssetFilledAmount,
    fillResults
        ...
        > {
            const self = this as any as TestExchangeInternalsContract;
            const functionSignature = 'publicUpdateFilledState({address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes},address,bytes32,uint256,{uint256,uint256,uint256,uint256})';
            const inputAbi = self._lookupAbi(functionSignature).inputs;
            [order,
        takerAddress,
        orderHash,
        ...
        fillResults
            ...
            const ethersFunction = self._lookupEthersInterface(functionSignature).functions.publicUpdateFilledState;
        ...
        fillResults
            ...
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            let resultArray = ethersFunction.decode(rawCallResult);
            const outputAbi = (_.find(self.abi, {name: 'publicUpdateFilledState'}) as MethodAbi).outputs;
            resultArray = BaseContract._formatABIDataItemList(outputAbi, resultArray, BaseContract._lowercaseAddress.bind(this));
            resultArray = BaseContract._formatABIDataItemList(outputAbi, resultArray, BaseContract._bnToBigNumber.bind(this));
            return resultArray;
        },
    ...
    public publicSafeGetPartialAmountFloor = {
        ...
        > {
            const self = this as any as TestExchangeInternalsContract;
            const functionSignature = 'publicSafeGetPartialAmountFloor(uint256,uint256,uint256)';
            const inputAbi = self._lookupAbi(functionSignature).inputs;
            [numerator,
        denominator,
        target
        ...
        target
            ...
            const ethersFunction = self._lookupEthersInterface(functionSignature).functions.publicSafeGetPartialAmountFloor;
            const encodedData = ethersFunction.encode([numerator,
        denominator,
        target
        ]);
            ...
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            let resultArray = ethersFunction.decode(rawCallResult);
            const outputAbi = (_.find(self.abi, {name: 'publicSafeGetPartialAmountFloor'}) as MethodAbi).outputs;
            resultArray = BaseContract._formatABIDataItemList(outputAbi, resultArray, BaseContract._lowercaseAddress.bind(this));
            resultArray = BaseContract._formatABIDataItemList(outputAbi, resultArray, BaseContract._bnToBigNumber.bind(this));
            return resultArray[0];
        },
    ...
    public publicSafeGetPartialAmountCeil = {
        ...
        > {
            const self = this as any as TestExchangeInternalsContract;
            const functionSignature = 'publicSafeGetPartialAmountCeil(uint256,uint256,uint256)';
            const inputAbi = self._lookupAbi(functionSignature).inputs;
            [numerator,
        denominator,
        target
        ...
        target
            ...
            const ethersFunction = self._lookupEthersInterface(functionSignature).functions.publicSafeGetPartialAmountCeil;
            const encodedData = ethersFunction.encode([numerator,
        denominator,
        target
        ]);
            ...
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            let resultArray = ethersFunction.decode(rawCallResult);
            const outputAbi = (_.find(self.abi, {name: 'publicSafeGetPartialAmountCeil'}) as MethodAbi).outputs;
            resultArray = BaseContract._formatABIDataItemList(outputAbi, resultArray, BaseContract._lowercaseAddress.bind(this));
            resultArray = BaseContract._formatABIDataItemList(outputAbi, resultArray, BaseContract._bnToBigNumber.bind(this));
            return resultArray[0];
        },
    ...
    public publicCalculateFillResults = {
        ...
        > {
            const self = this as any as TestExchangeInternalsContract;
            const functionSignature = 'publicCalculateFillResults({address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes},uint256)';
            const inputAbi = self._lookupAbi(functionSignature).inputs;
            [order,
        ...
        takerAssetFilledAmount
            ...
            const ethersFunction = self._lookupEthersInterface(functionSignature).functions.publicCalculateFillResults;
            const encodedData = ethersFunction.encode([order,
        takerAssetFilledAmount
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
            ...
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            let resultArray = ethersFunction.decode(rawCallResult);
            const outputAbi = (_.find(self.abi, {name: 'publicCalculateFillResults'}) as MethodAbi).outputs;
            resultArray = BaseContract._formatABIDataItemList(outputAbi, resultArray, BaseContract._lowercaseAddress.bind(this));
            resultArray = BaseContract._formatABIDataItemList(outputAbi, resultArray, BaseContract._bnToBigNumber.bind(this));
            return resultArray[0];
        },
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return TestExchangeInternalsContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    ...
    constructor(abi: ContractAbi, address: string, provider: Provider, txDefaults?: Partial<TxData>) {
        super('TestExchangeInternals', abi, address, provider, txDefaults);
