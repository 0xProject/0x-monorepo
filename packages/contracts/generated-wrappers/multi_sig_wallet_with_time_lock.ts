...
export class MultiSigWalletWithTimeLockContract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return MultiSigWalletWithTimeLockContract.deployAsync(bytecode, abi, provider, txDefaults, _owners,
_required,
_secondsTimeLocked
);
    }
...
_secondsTimeLocked
        ...
        const contractInstance = new MultiSigWalletWithTimeLockContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
