...
export class MultiSigWalletContract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return MultiSigWalletContract.deployAsync(bytecode, abi, provider, txDefaults, _owners,
_required
);
    }
...
_required
        ...
        const contractInstance = new MultiSigWalletContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
