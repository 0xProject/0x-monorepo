...
export class OrderValidationUtilsContract extends BaseContract {
    public decodeERC721AssetData = {
        ...
        > {
            ...
            const self = this as any as OrderValidationUtilsContract;
    ...
    public getOrderRelevantStates = {
        ...
        > {
            ...
            const self = this as any as OrderValidationUtilsContract;
            const encodedData = self._strictEncodeArguments('getOrderRelevantStates((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes)[],bytes[])', [orders,
        signatures
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('getOrderRelevantStates((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes)[],bytes[])');
            // tslint:disable boolean-naming
    ...
    public getOrderRelevantState = {
        ...
        > {
            ...
            const self = this as any as OrderValidationUtilsContract;
            const encodedData = self._strictEncodeArguments('getOrderRelevantState((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes),bytes)', [order,
        signature
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('getOrderRelevantState((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes),bytes)');
            // tslint:disable boolean-naming
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return OrderValidationUtilsContract.deployAsync(bytecode, abi, provider, txDefaults, _exchange,
_zrxAssetData
);
    }
...
_zrxAssetData
        ...
        logUtils.log(`OrderValidationUtils successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new OrderValidationUtilsContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
...
_zrxAssetData
    ...
    constructor(abi: ContractAbi, address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('OrderValidationUtils', abi, address, supportedProvider, txDefaults);
