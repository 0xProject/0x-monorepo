...
export class ERC1155MintableContract extends BaseContract {
    ...
    public create = {
        ...
        async sendTransactionAsync(
            ...
            if (opts.shouldValidate !== false) {
                await self.create.callAsync(uri, isNF, txDataWithDefaults);
            }
        ...
        awaitTransactionSuccessAsync(
            ...
            assert.isBoolean('isNF', isNF);
            const self = (this as any) as ERC1155MintableContract;
            const txHashPromise = self.create.sendTransactionAsync(uri, isNF, txData, opts);
    ...
    public createWithType = {
        ...
        async sendTransactionAsync(
            ...
            if (opts.shouldValidate !== false) {
                await self.createWithType.callAsync(type_, uri, txDataWithDefaults);
            }
        ...
        awaitTransactionSuccessAsync(
            ...
            assert.isString('uri', uri);
            const self = (this as any) as ERC1155MintableContract;
            const txHashPromise = self.createWithType.sendTransactionAsync(type_, uri, txData, opts);
            return new PromiseWithTransactionHash<TransactionReceiptWithDecodedLogs>(
                txHashPromise,
                (async (): Promise<TransactionReceiptWithDecodedLogs> => {
                    // When the transaction hash resolves, wait for it to be mined.
    ...
    public mintFungible = {
        ...
        async sendTransactionAsync(
            ...
            if (opts.shouldValidate !== false) {
                await self.mintFungible.callAsync(id, to, quantities, txDataWithDefaults);
            }
        ...
        awaitTransactionSuccessAsync(
            ...
            assert.isArray('quantities', quantities);
            const self = (this as any) as ERC1155MintableContract;
            const txHashPromise = self.mintFungible.sendTransactionAsync(id, to, quantities, txData, opts);
            return new PromiseWithTransactionHash<TransactionReceiptWithDecodedLogs>(
                txHashPromise,
                (async (): Promise<TransactionReceiptWithDecodedLogs> => {
                    // When the transaction hash resolves, wait for it to be mined.
    ...
    public mintNonFungible = {
        ...
        async sendTransactionAsync(
            ...
            if (opts.shouldValidate !== false) {
                await self.mintNonFungible.callAsync(type_, to, txDataWithDefaults);
            }
        ...
        awaitTransactionSuccessAsync(
            ...
            assert.isArray('to', to);
            const self = (this as any) as ERC1155MintableContract;
            const txHashPromise = self.mintNonFungible.sendTransactionAsync(type_, to, txData, opts);
            return new PromiseWithTransactionHash<TransactionReceiptWithDecodedLogs>(
                txHashPromise,
                (async (): Promise<TransactionReceiptWithDecodedLogs> => {
                    // When the transaction hash resolves, wait for it to be mined.
    ...
    public safeBatchTransferFrom = {
        ...
        async sendTransactionAsync(
            ...
            if (opts.shouldValidate !== false) {
                await self.safeBatchTransferFrom.callAsync(from, to, ids, values, data, txDataWithDefaults);
            }
    ...
    public safeTransferFrom = {
        ...
        async sendTransactionAsync(
            ...
            if (opts.shouldValidate !== false) {
                await self.safeTransferFrom.callAsync(from, to, id, value, data, txDataWithDefaults);
            }
    ...
    public setApprovalForAll = {
        ...
        async sendTransactionAsync(
            ...
            if (opts.shouldValidate !== false) {
                await self.setApprovalForAll.callAsync(operator, approved, txDataWithDefaults);
            }
