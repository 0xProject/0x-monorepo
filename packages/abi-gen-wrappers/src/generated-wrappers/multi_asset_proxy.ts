...
export class MultiAssetProxyContract extends BaseContract {
    ...
    public getFunctionSignature(methodName: string): string {
        ...
        const methodAbi = MultiAssetProxyContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    constructor(
        ...
        MultiAssetProxyContract.ABI().forEach((item, index) => {
