...
export class IAssetProxyContract extends BaseContract {
    ...
    public getFunctionSignature(methodName: string): string {
        ...
        const methodAbi = IAssetProxyContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    constructor(
        ...
        IAssetProxyContract.ABI().forEach((item, index) => {
