...
export class ERC20TokenContract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return ERC20TokenContract.deployAsync(evm, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        const contractInstance = new ERC20TokenContract(abi, evm.deployedBytecode.object, txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(abi: ContractAbi, bytecode: string, address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('ERC20Token', abi, bytecode, address, supportedProvider, txDefaults);
