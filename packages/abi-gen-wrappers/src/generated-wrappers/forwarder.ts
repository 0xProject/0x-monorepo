...
public static async deployFrom0xArtifactAsync(
        ...
        return ForwarderContract.deployAsync(bytecode, abi, provider, txDefaults, abiDependencies, _exchange,
_zrxAssetData,
_wethAssetData
);
    }
...
_wethAssetData
        ...
        const contractInstance = new ForwarderContract(txReceipt.contractAddress as string, provider, txDefaults, abiDependencies);
