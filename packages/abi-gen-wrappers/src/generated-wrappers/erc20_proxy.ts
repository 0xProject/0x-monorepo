...
export class ERC20ProxyContract extends BaseContract {
    ...
    private _subscriptionManagerIfExists?: SubscriptionManager<ERC20ProxyEventArgs, ERC20ProxyEvents>;
    ...
    public async getSubscriptionManagerAsync(): Promise<SubscriptionManager<ERC20ProxyEventArgs, ERC20ProxyEvents>> {
        if (this._subscriptionManagerIfExists === undefined) {
            const networkId = await this._web3Wrapper.getNetworkIdAsync();
            this._subscriptionManagerIfExists = new SubscriptionManager<ERC20ProxyEventArgs, ERC20ProxyEvents>(
     ...
     */
    public async subscribeAsync<ArgsType extends ERC20ProxyEventArgs>(
