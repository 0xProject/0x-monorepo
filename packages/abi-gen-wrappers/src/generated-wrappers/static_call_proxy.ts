...
export class StaticCallProxyContract extends BaseContract {
    ...
    public getFunctionSignature(methodName: string): string {
        ...
        const methodAbi = StaticCallProxyContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
     ...
     */
    public transferFrom(assetData: string, from: string, to: string, amount: BigNumber): ContractFunctionObj<void> {
        const self = (this as any) as StaticCallProxyContract;
     ...
     * @returns Proxy id.
     */
    public getProxyId(): ContractFunctionObj<string> {
        const self = (this as any) as StaticCallProxyContract;
    ...
    constructor(
        ...
        StaticCallProxyContract.ABI().forEach((item, index) => {
