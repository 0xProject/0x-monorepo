...
export class ERC721ProxyContract extends BaseContract {
    ...
    public getFunctionSignature(methodName: string): string {
        ...
        const methodAbi = ERC721ProxyContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    constructor(
        ...
        ERC721ProxyContract.ABI().forEach((item, index) => {
