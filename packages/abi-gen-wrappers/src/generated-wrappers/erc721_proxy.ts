...
export class ERC721ProxyContract extends BaseContract {
    ...
    private _subscriptionManagerIfExists?: SubscriptionManager<ERC721ProxyEventArgs, ERC721ProxyEvents>;
    ...
    public async getSubscriptionManagerAsync(): Promise<SubscriptionManager<ERC721ProxyEventArgs, ERC721ProxyEvents>> {
        if (this._subscriptionManagerIfExists === undefined) {
            const networkId = await this._web3Wrapper.getNetworkIdAsync();
            this._subscriptionManagerIfExists = new SubscriptionManager<ERC721ProxyEventArgs, ERC721ProxyEvents>(
     ...
     */
    public async subscribeAsync<ArgsType extends ERC721ProxyEventArgs>(
