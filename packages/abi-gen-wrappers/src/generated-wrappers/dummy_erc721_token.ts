...
public static async deployFrom0xArtifactAsync(
        ...
        return DummyERC721TokenContract.deployAsync(bytecode, abi, provider, txDefaults, abiDependencies, _name,
_symbol
);
    }
...
_symbol
        ...
        const contractInstance = new DummyERC721TokenContract(txReceipt.contractAddress as string, provider, txDefaults, abiDependencies);
