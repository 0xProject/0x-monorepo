...
export class DummyERC20TokenContract extends BaseContract {
    ...
    public mint = {
        async sendTransactionAsync(
            ...
            const encodedData = self._lookupEthersInterface('mint(uint256)').encode([_value
    ]);;
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                    to: self.address,
        ...
        getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = self._lookupEthersInterface('mint(uint256)').encode([_value
    ]);
            return abiEncodedTransactionData;
        },
        async callAsync(
    ...
    _value
            ...
            const encodedData = self._lookupEthersInterface('setBalance(address,uint256)').encode([_target,
    _value
    ]);;
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
    ...
    _value
            ...
            const abiEncodedTransactionData = self._lookupEthersInterface('setBalance(address,uint256)').encode([_target,
    _value
    ]);
            return abiEncodedTransactionData;
        },
