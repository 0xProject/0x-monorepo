...
export class DummyERC20TokenContract extends BaseContract {
    ...
    public setBalance = {
        ...
        assert.isBigNumber('_value', _value);
        const self = this as any as DummyERC20TokenContract;
        const encodedData = self._strictEncodeArguments('setBalance(address,uint256)', [_target.toLowerCase(),
    _value
    ]);
        const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
            {
        ...
        assert.isBigNumber('_value', _value);
        const self = this as any as DummyERC20TokenContract;
        const txHashPromise = self.setBalance.sendTransactionAsync(_target.toLowerCase(),
    _value
    , txData);
        return new PromiseWithTransactionHash<TransactionReceiptWithDecodedLogs>(
            txHashPromise,
    ...
    _value
        ...
        getABIEncodedTransactionData(
            ...
            assert.isBigNumber('_value', _value);
            const self = this as any as DummyERC20TokenContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('setBalance(address,uint256)', [_target.toLowerCase(),
        _value
        ]);
            return abiEncodedTransactionData;
        },
...
public static async deployFrom0xArtifactAsync(
        ...
        return DummyERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, _name,
_symbol,
_decimals,
_totalSupply
);
...
_totalSupply
        ...
        const contractInstance = new DummyERC20TokenContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
...
_totalSupply
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: { [contractName: string]: ContractAbi }) {
        super('DummyERC20Token', DummyERC20TokenContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies);
