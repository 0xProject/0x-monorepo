...
export class ZRXTokenContract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return ZRXTokenContract.deployAsync(evm, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        const contractInstance = new ZRXTokenContract(abi, evm.deployedBytecode.object, txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(abi: ContractAbi, bytecode: string, address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('ZRXToken', abi, bytecode, address, supportedProvider, txDefaults);
