...
export class WETH9Contract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return WETH9Contract.deployAsync(evm, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        const contractInstance = new WETH9Contract(abi, evm.deployedBytecode.object, txReceipt.contractAddress as string, provider, txDefaults);
