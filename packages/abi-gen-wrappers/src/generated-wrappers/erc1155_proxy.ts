...
export class ERC1155ProxyContract extends BaseContract {
    ...
    public getFunctionSignature(methodName: string): string {
        ...
        const methodAbi = ERC1155ProxyContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
     ...
     */
    public transferFrom(assetData: string, from: string, to: string, amount: BigNumber): ContractTxFunctionObj<void> {
        const self = (this as any) as ERC1155ProxyContract;
    ...
    constructor(
        ...
        ERC1155ProxyContract.ABI().forEach((item, index) => {
