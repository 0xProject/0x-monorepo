...
// Returns the ABI that was used to generate this wrapper
// Hardcoded, do not edit!
function ABI(): ContractAbi {
    // HACK (xianny): handlebars cannot directly pass an array
    return JSON.parse(
        `[{"constant":true,"inputs":[{"name":"hash","type":"bytes32"},{"name":"signerAddress","type":"address"},{"name":"signature","type":"bytes"}],"name":"isValidSignature","outputs":[{"name":"isValid","type":"bool"}],"payable":false,"stateMutability":"view","type":"function"}]`,
    );
}
