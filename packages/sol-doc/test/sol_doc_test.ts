...
describe('transformDocs()', () => {
    ...
    const INPUT_DOCS: SolidityDocs = {
        contracts: {
            ...
            [TEST_CONTRACT]: _.merge(
                randomContract(
                    TEST_CONTRACT,
                    {kind: ContractKind.Contract, inherits: [BASE_CONTRACT] },
                ),
                {
                    methods: [
                        randomMethod({
    ...
    function getMethodId(method: ContractMethodDocs): string {
    ...
    describe('flattening', () => {
        it('merges inherited methods', () => {
            ...
            const allMethods = _.uniqBy(_.flatten([BASE_CONTRACT, TEST_CONTRACT]
                    .map(c => INPUT_DOCS.contracts[c].methods
