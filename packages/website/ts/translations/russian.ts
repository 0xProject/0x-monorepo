...
export const russian = {
    ...
    [Key.TopTagline]:
        '0x — это протокол с открытым кодом, позволяющий торговать токенами ERC20, на блокчейне Ethereum.',
    [Key.BuildCallToAction]: 'Разрабатывайте на 0x',
    [Key.CommunityCallToAction]: 'Сообщество',
    [Key.ProjectsHeader]: 'Прожкты разработанные на 0х',
    ...
    [Key.OffChainOrderRelay]: 'Офчейн-ордер',
    ...
    [Key.DevToolsPrompt]: 'Узнайте как это сделать в документации к',
    [Key.SmartContract]: 'смарт-контрактам',
    [Key.Docs]: '',
    [Key.And]: 'и',
    [Key.DecentralizedGovernance]: 'Децентрализированное управление',
    ...
    [Key.PredictionMarkets]: 'Рынки предсказаний',
    ...
    [Key.DecentralizedLoans]: 'Децентрализированные займы',
    ...
    // TopBar
    [Key.Developers]: 'Для разработчиков',
};
