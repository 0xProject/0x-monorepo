...
public static async deployFrom0xArtifactAsync(
    ...
    public static async deployAsync(
        ...
        const contractInstance = new ERC20BridgeSamplerContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
 ...
 * Calls the provider contract with the default gas limit (200k).
    ...
    * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    public sampleBuysFromLiquidityProvider1(
 ...
 * Calls the provider contract with the default gas limit (200k).
    ...
    * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    public sampleBuysFromLiquidityProvider2(
            providerAddress: string,
            takerToken: string,
            makerToken: string,
            makerTokenAmounts: BigNumber[],
...
> {
        const self = this as any as ERC20BridgeSamplerContract;
            ...
            assert.isString('makerToken', makerToken);
            assert.isArray('makerTokenAmounts', makerTokenAmounts);
            assert.isBigNumber('callGasLimit', callGasLimit);
        const functionSignature = 'sampleBuysFromLiquidityProvider(address,address,address,uint256[],uint256)';
 ...
 * Calls the provider contract with the default gas limit (200k).
    ...
    * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    public sampleSellsFromLiquidityProvider1(
            providerAddress: string,
            takerToken: string,
            makerToken: string,
            takerTokenAmounts: BigNumber[],
...
> {
    ...
    * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    public sampleSellsFromLiquidityProvider2(
            providerAddress: string,
            takerToken: string,
            makerToken: string,
            takerTokenAmounts: BigNumber[],
...
> {
        const self = this as any as ERC20BridgeSamplerContract;
            ...
            assert.isArray('takerTokenAmounts', takerTokenAmounts);
            assert.isBigNumber('callGasLimit', callGasLimit);
        const functionSignature = 'sampleSellsFromLiquidityProvider(address,address,address,uint256[],uint256)';
...
> {
    ...
    constructor(
        ...
        super('ERC20BridgeSampler', ERC20BridgeSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
