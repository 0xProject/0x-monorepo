...
const IS_CANARY_PUBLISH = process.env.IS_CANARY_PUBLISH === 'true';
...
export const configs = {
    ...
    IS_CANARY_PUBLISH,
    DIST_TAG,
    NPM_REGISTRY_URL: IS_LOCAL_PUBLISH || IS_CANARY_PUBLISH ? LOCAL_NPM_REGISTRY_URL : REMOTE_NPM_REGISTRY_URL,
