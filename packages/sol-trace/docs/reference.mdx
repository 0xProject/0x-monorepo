...
*Defined in [sol-trace/src/revert_trace_subprovider.ts:27](https://github.com/0xProject/0x-monorepo/blob/23602ec6b/packages/sol-trace/src/revert_trace_subprovider.ts#L27)*
