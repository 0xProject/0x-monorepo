...
export class ForwarderContract extends BaseContract {
    public initialize = {
        async sendTransactionAsync(txData: TxData = {}): Promise<string> {
            ...
            const theAbi: Web3.MethodAbi = _.find(self.abi, { name: 'initialize ' }) as Web3.MethodAbi;
            const inputAbi = theAbi.inputs;
    ...
    public fillOrder = {
        async sendTransactionAsync(
            ...
            const self = this as ForwarderContract;
            const theAbi: Web3.MethodAbi = _.find(self.abi, { name: 'fillOrder ' }) as Web3.MethodAbi;
            const inputAbi = theAbi.inputs;
