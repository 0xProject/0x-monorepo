...
export const signatureUtils = {
    ...
    async isValidPresignedSignatureAsync(
        ...
        const exchangeContract = new ExchangeContract(
            ...
            artifacts.Exchange.compilerOutput.evm.deployedBytecode.object,
            addresses.exchange,
            provider,
        );
    ...
    async isValidWalletSignatureAsync(
        ...
        const walletContract = new IWalletContract(
            ...
            artifacts.IWallet.compilerOutput.evm.deployedBytecode.object,
            signerAddress,
            provider,
        );
    ...
    async isValidValidatorSignatureAsync(
        ...
        const validatorContract = new IValidatorContract(
            ...
            artifacts.IValidator.compilerOutput.evm.deployedBytecode.object,
            signerAddress,
            provider,
        );
