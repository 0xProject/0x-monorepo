...
export type MultiSigWalletWithTimeLockContractEventArgs =
...
export class MultiSigWalletWithTimeLockContract extends BaseContract {
    ...
    public static async deployAsync(
        ...
        const txData = ethers.Contract.getDeployTransaction(bytecode, abi, _owners, _required, _secondsTimeLocked);
