...
/**
 * Async function that removes the concepts.radar_orderbook_usd_prices table if it exists
 * @param connection connection to the db instance
 */
export async function deleteTableAsync(connection: Connection): Promise<void> {
    await connection.query(`drop table if exists concepts.radar_orderbook_usd_prices`);
}

/**
 * Async function that creates the concepts.radar_orderbook_usd_prices table
 * @param connection connection to the db instance
 */
export async function createTableAsync(connection: Connection): Promise<void> {
