...
contracts_test_utils_1.blockchainTests.resets('AffiliateFeeTransformer', function (env) {
    var recipients = new Array(2).fill(0).map(function () { return contracts_test_utils_1.randomAddress(); });
    var caller;
    var token;
    var transformer;
    var host;
    before(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    token = _b.sent();
                    return [4 /*yield*/, wrappers_1.AffiliateFeeTransformerContract.deployFrom0xArtifactAsync(artifacts_1.artifacts.AffiliateFeeTransformer, env.provider, env.txDefaults, artifacts_1.artifacts)];
                case 3:
                    transformer = _b.sent();
    ...
    it('can transfer a token and ETH', function () { return __awaiter(_this, void 0, void 0, function () {
        var amounts, tokens, data, _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    amounts = recipients.map(function () { return contracts_test_utils_1.getRandomInteger(1, '1e18'); });
                    tokens = [token.address, constants_1.ETH_TOKEN_ADDRESS];
                    data = transformer_data_encoders_1.encodeAffiliateFeeTransformerData({
                        fees: recipients.map(function (r, i) { return ({
                            token: tokens[i],
                            amount: amounts[i],
                            recipient: r,
                        }); }),
                ...
                case 2:
                    _d.sent();
                    return [4 /*yield*/, host
                            .rawExecuteTransform(transformer.address, utils_1.hexUtils.random(), contracts_test_utils_1.randomAddress(), data)
                ...
                case 4:
                    _a.apply(void 0, [_d.sent()]).to.deep.eq(ZERO_BALANCES);
                    _b = contracts_test_utils_1.expect;
                    return [4 /*yield*/, getBalancesAsync(recipients[0])];
                case 5:
                    _b.apply(void 0, [_d.sent()]).to.deep.eq({
                        tokenBalance: amounts[0],
                        ethBalance: ZERO_AMOUNT,
                    });
                    _c = contracts_test_utils_1.expect;
                    return [4 /*yield*/, getBalancesAsync(recipients[1])];
                case 6:
                    _c.apply(void 0, [_d.sent()]).to.deep.eq({
                        tokenBalance: ZERO_AMOUNT,
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, getBalancesAsync(host.address)];
                case 4:
                    _a.apply(void 0, [_d.sent()]).to.deep.eq({
