...
var TestERC20BridgeSamplerContract = /** @class */ (function (_super) {
    __extends(TestERC20BridgeSamplerContract, _super);
    function TestERC20BridgeSamplerContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TestERC20BridgeSamplerContract.deployedBytecode; }
        var _this = _super.call(this, 'TestERC20BridgeSampler', TestERC20BridgeSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        TestERC20BridgeSamplerContract.ABI().forEach(function (item, index) {
    ...
    TestERC20BridgeSamplerContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TestERC20BridgeSamplerContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TestERC20BridgeSamplerContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TestERC20BridgeSamplerContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TestERC20BridgeSamplerContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new TestERC20BridgeSamplerContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TestERC20BridgeSamplerContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    TestERC20BridgeSamplerContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TestERC20BridgeSamplerContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TestERC20BridgeSamplerContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TestERC20BridgeSamplerContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TestERC20BridgeSamplerContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TestERC20BridgeSamplerContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TestERC20BridgeSamplerContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    TestERC20BridgeSamplerContract.prototype.FAILURE_ADDRESS = function () {
        var self = this;
        var functionSignature = 'FAILURE_ADDRESS()';
        return {
    ...
    * @returns callResults ABI-encoded results data for each call.
     */
    TestERC20BridgeSamplerContract.prototype.batchCall = function (callDatas) {
        var self = this;
        assert_1.assert.isArray('callDatas', callDatas);
        var functionSignature = 'batchCall(bytes[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    TestERC20BridgeSamplerContract.prototype.createTokenExchanges = function (tokenAddresses) {
        var self = this;
        assert_1.assert.isArray('tokenAddresses', tokenAddresses);
        var functionSignature = 'createTokenExchanges(address[])';
        return {
    ...
    ;
    TestERC20BridgeSamplerContract.prototype.enableFailTrigger = function () {
        var self = this;
        var functionSignature = 'enableFailTrigger()';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    TestERC20BridgeSamplerContract.prototype.eth2Dai = function () {
        var self = this;
        var functionSignature = 'eth2Dai()';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
 ...
 * Returns address(0) if no such provider exists in the registry.
    ...
    * @returns providerAddress Address of the liquidity provider.
     */
    TestERC20BridgeSamplerContract.prototype.getLiquidityProviderFromRegistry = function (registryAddress, takerToken, makerToken) {
        var self = this;
        ...
        var functionSignature = 'getLiquidityProviderFromRegistry(address,address,address)';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
 ...
 * Effectively ignores orders that have empty signatures or
    ...
    * @returns orderFillableMakerAssetAmounts How much maker asset can be filled         by each order in &#x60;orders&#x60;.
     */
    TestERC20BridgeSamplerContract.prototype.getOrderFillableMakerAssetAmounts = function (orders, orderSignatures) {
        var self = this;
        assert_1.assert.isArray('orders', orders);
        assert_1.assert.isArray('orderSignatures', orderSignatures);
        var functionSignature = 'getOrderFillableMakerAssetAmounts((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes,bytes,bytes)[],bytes[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
 ...
 * maker/taker asset amounts (returning 0).
    ...
    * @returns orderFillableTakerAssetAmounts How much taker asset can be filled         by each order in &#x60;orders&#x60;.
     */
    TestERC20BridgeSamplerContract.prototype.getOrderFillableTakerAssetAmounts = function (orders, orderSignatures) {
        var self = this;
        assert_1.assert.isArray('orders', orders);
        assert_1.assert.isArray('orderSignatures', orderSignatures);
        var functionSignature = 'getOrderFillableTakerAssetAmounts((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes,bytes,bytes)[],bytes[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    TestERC20BridgeSamplerContract.prototype.getOrderRelevantState = function (order, index_1) {
        var self = this;
    ...
    ;
    TestERC20BridgeSamplerContract.prototype.kyber = function () {
        var self = this;
        var functionSignature = 'kyber()';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    TestERC20BridgeSamplerContract.prototype.sampleBuysFromEth2Dai = function (takerToken, makerToken, makerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('makerTokenAmounts', makerTokenAmounts);
        var functionSignature = 'sampleBuysFromEth2Dai(address,address,uint256[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    TestERC20BridgeSamplerContract.prototype.sampleBuysFromLiquidityProviderRegistry = function (registryAddress, takerToken, makerToken, makerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('registryAddress', registryAddress);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('makerTokenAmounts', makerTokenAmounts);
        var functionSignature = 'sampleBuysFromLiquidityProviderRegistry(address,address,address,uint256[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    TestERC20BridgeSamplerContract.prototype.sampleBuysFromUniswap = function (takerToken, makerToken, makerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('makerTokenAmounts', makerTokenAmounts);
        var functionSignature = 'sampleBuysFromUniswap(address,address,uint256[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    TestERC20BridgeSamplerContract.prototype.sampleSellsFromCurve = function (curveAddress, fromTokenIdx, toTokenIdx, takerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('curveAddress', curveAddress);
        ...
        var functionSignature = 'sampleSellsFromCurve(address,int128,int128,uint256[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    TestERC20BridgeSamplerContract.prototype.sampleSellsFromEth2Dai = function (takerToken, makerToken, takerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
        var functionSignature = 'sampleSellsFromEth2Dai(address,address,uint256[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    TestERC20BridgeSamplerContract.prototype.sampleSellsFromKyberNetwork = function (takerToken, makerToken, takerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
        var functionSignature = 'sampleSellsFromKyberNetwork(address,address,uint256[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    TestERC20BridgeSamplerContract.prototype.sampleSellsFromLiquidityProviderRegistry = function (registryAddress, takerToken, makerToken, takerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('registryAddress', registryAddress);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
        var functionSignature = 'sampleSellsFromLiquidityProviderRegistry(address,address,address,uint256[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    TestERC20BridgeSamplerContract.prototype.sampleSellsFromUniswap = function (takerToken, makerToken, takerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
        var functionSignature = 'sampleSellsFromUniswap(address,address,uint256[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    TestERC20BridgeSamplerContract.prototype.uniswap = function () {
        var self = this;
        var functionSignature = 'uniswap()';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    return TestERC20BridgeSamplerContract;
