...
export declare type TransformERC20FeatureEventArgs = TransformERC20FeatureQuoteSignerUpdatedEventArgs | TransformERC20FeatureTransformedERC20EventArgs | TransformERC20FeatureTransformerDeployerUpdatedEventArgs;
export declare enum TransformERC20FeatureEvents {
...
export interface TransformERC20FeatureQuoteSignerUpdatedEventArgs extends DecodedLogArgs {
    quoteSigner: string;
}
export interface TransformERC20FeatureTransformedERC20EventArgs extends DecodedLogArgs {
    taker: string;
    inputToken: string;
    outputToken: string;
...
export interface TransformERC20FeatureTransformerDeployerUpdatedEventArgs extends DecodedLogArgs {
    transformerDeployer: string;
}
export declare class TransformERC20FeatureContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }): Promise<TransformERC20FeatureContract>;
 ...
 * to an ERC20 `outputToken`.
     ...
     */
    subscribe<ArgsType extends TransformERC20FeatureEventArgs>(eventName: TransformERC20FeatureEvents, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>, isVerbose?: boolean, blockPollingIntervalMs?: number): string;
    /**
     ...
     */
    getLogsAsync<ArgsType extends TransformERC20FeatureEventArgs>(eventName: TransformERC20FeatureEvents, blockRange: BlockRange, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: {
        [contractName: string]: ContractAbi;
    }, deployedBytecode?: string | undefined);
}
//# sourceMappingURL=transform_erc20_feature.d.ts.map