...
var TransformERC20Events;
(function (TransformERC20Events) {
    TransformERC20Events["TransformedERC20"] = "TransformedERC20";
    TransformERC20Events["TransformerDeployerUpdated"] = "TransformerDeployerUpdated";
})(TransformERC20Events = exports.TransformERC20Events || (exports.TransformERC20Events = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var TransformERC20Contract = /** @class */ (function (_super) {
    __extends(TransformERC20Contract, _super);
    function TransformERC20Contract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TransformERC20Contract.deployedBytecode; }
        var _this = _super.call(this, 'TransformERC20', TransformERC20Contract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(TransformERC20Contract.ABI(), _this._web3Wrapper);
        TransformERC20Contract.ABI().forEach(function (item, index) {
    ...
    TransformERC20Contract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TransformERC20Contract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TransformERC20Contract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TransformERC20Contract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TransformERC20Contract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("TransformERC20 successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TransformERC20Contract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TransformERC20Contract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    TransformERC20Contract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TransformERC20Contract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TransformERC20Contract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TransformERC20Contract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TransformERC20Contract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TransformERC20Contract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TransformERC20Contract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    TransformERC20Contract.prototype.FEATURE_NAME = function () {
        var self = this;
    ...
    ;
    TransformERC20Contract.prototype.FEATURE_VERSION = function () {
        var self = this;
     ...
     */
    TransformERC20Contract.prototype._transformERC20 = function (callDataHash, taker, inputToken, outputToken, inputTokenAmount, minOutputTokenAmount, transformations) {
        var self = this;
 ...
 * Anyone can call this.
     */
    TransformERC20Contract.prototype.createTransformWallet = function () {
        var self = this;
 ...
 * context for transformations.
     */
    TransformERC20Contract.prototype.getTransformWallet = function () {
        var self = this;
     ...
     */
    TransformERC20Contract.prototype.getTransformerDeployer = function () {
        var self = this;
 ...
 * Should be delegatecalled by `Migrate.migrate()`.
     ...
     */
    TransformERC20Contract.prototype.migrate = function (transformerDeployer) {
        var self = this;
 ...
 * Only callable by the owner.
     ...
     *     transformers.
     */
    TransformERC20Contract.prototype.setTransformerDeployer = function (transformerDeployer) {
        var self = this;
        assert_1.assert.isString('transformerDeployer', transformerDeployer);
 ...
 * to an ERC20 `outputToken`.
     ...
     *     balance(s)        in sequence.
     */
    TransformERC20Contract.prototype.transformERC20 = function (inputToken, outputToken, inputTokenAmount, minOutputTokenAmount, transformations) {
        var self = this;
        assert_1.assert.isString('inputToken', inputToken);
        assert_1.assert.isString('outputToken', outputToken);
        assert_1.assert.isBigNumber('inputTokenAmount', inputTokenAmount);
     ...
     */
    TransformERC20Contract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, TransformERC20Events);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, TransformERC20Contract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    TransformERC20Contract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    TransformERC20Contract.prototype.unsubscribeAll = function () {
     ...
     */
    TransformERC20Contract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, TransformERC20Contract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    TransformERC20Contract.contractName = 'TransformERC20';
    return TransformERC20Contract;
}(base_contract_1.BaseContract));
exports.TransformERC20Contract = TransformERC20Contract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=transform_erc20.js.map