...
var IFlashWalletContract = /** @class */ (function (_super) {
    __extends(IFlashWalletContract, _super);
    function IFlashWalletContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = IFlashWalletContract.deployedBytecode; }
        var _this = _super.call(this, 'IFlashWallet', IFlashWalletContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        IFlashWalletContract.ABI().forEach(function (item, index) {
    ...
    IFlashWalletContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IFlashWalletContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IFlashWalletContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, IFlashWalletContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    IFlashWalletContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IFlashWallet successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IFlashWalletContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    IFlashWalletContract.ABI = function () {
        var abi = [
            {
                inputs: [
                    {
    ...
    IFlashWalletContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, IFlashWalletContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    IFlashWalletContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = IFlashWalletContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    IFlashWalletContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    IFlashWalletContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    IFlashWalletContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
     ...
     */
    IFlashWalletContract.prototype.executeCall = function (target, callData, value) {
        var self = this;
 ...
 * Only an authority can call this.
      ...
      * @param callData The call data.
     */
    IFlashWalletContract.prototype.executeDelegateCall = function (target, callData) {
        var self = this;
        assert_1.assert.isString('target', target);
        assert_1.assert.isString('callData', callData);
    ...
    ;
    /**
     * Fetch the immutable owner/deployer of this contract.
     */
    IFlashWalletContract.prototype.owner = function () {
        var self = this;
    ...
    ;
    IFlashWalletContract.contractName = 'IFlashWallet';
    return IFlashWalletContract;
}(base_contract_1.BaseContract));
exports.IFlashWalletContract = IFlashWalletContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_flash_wallet.js.map