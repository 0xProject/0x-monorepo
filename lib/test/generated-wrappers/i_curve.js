...
var ICurveContract = /** @class */ (function (_super) {
    __extends(ICurveContract, _super);
    function ICurveContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = ICurveContract.deployedBytecode; }
        var _this = _super.call(this, 'ICurve', ICurveContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        ICurveContract.ABI().forEach(function (item, index) {
    ...
    ICurveContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, ICurveContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    ICurveContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ICurveContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    ICurveContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("ICurve successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new ICurveContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
    ...
    ICurveContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, ICurveContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    ICurveContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = ICurveContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    ICurveContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    ICurveContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    ICurveContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
 ...
 * This function exists on early versions of Curve (USDC/DAI)
     ...
     */
    ICurveContract.prototype.exchange_underlying2 = function (i, j, sellAmount, minBuyAmount, deadline) {
        var self = this;
        assert_1.assert.isBigNumber('i', i);
        assert_1.assert.isBigNumber('j', j);
        ...
        var functionSignature = 'exchange_underlying(int128,int128,uint256,uint256,uint256)';
        return {
 ...
 * This function exists on later versions of Curve (USDC/DAI/USDT)
      ...
      * @param minBuyAmount The minimum buy amount of the token being bought.
     */
    ICurveContract.prototype.exchange_underlying1 = function (i, j, sellAmount, minBuyAmount) {
        var self = this;
        assert_1.assert.isBigNumber('i', i);
        assert_1.assert.isBigNumber('j', j);
        assert_1.assert.isBigNumber('sellAmount', sellAmount);
        assert_1.assert.isBigNumber('minBuyAmount', minBuyAmount);
        var functionSignature = 'exchange_underlying(int128,int128,uint256,uint256)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
 ...
 * This function exists on later versions of Curve (USDC/DAI/USDT)
     ...
     */
    ICurveContract.prototype.get_dx_underlying = function (i, j, buyAmount) {
        var self = this;
        assert_1.assert.isBigNumber('i', i);
        assert_1.assert.isBigNumber('j', j);
        assert_1.assert.isBigNumber('buyAmount', buyAmount);
        var functionSignature = 'get_dx_underlying(int128,int128,uint256)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     * Get the amount of `toToken` by selling `sellAmount` of `fromToken`
      ...
      * @param sellAmount The amount of token being bought.
     */
    ICurveContract.prototype.get_dy_underlying = function (i, j, sellAmount) {
        var self = this;
        assert_1.assert.isBigNumber('i', i);
        assert_1.assert.isBigNumber('j', j);
        assert_1.assert.isBigNumber('sellAmount', sellAmount);
        var functionSignature = 'get_dy_underlying(int128,int128,uint256)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    ICurveContract.prototype.underlying_coins = function (i) {
        var self = this;
        assert_1.assert.isBigNumber('i', i);
        var functionSignature = 'underlying_coins(int128)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    ICurveContract.contractName = 'ICurve';
    return ICurveContract;
}(base_contract_1.BaseContract));
exports.ICurveContract = ICurveContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_curve.js.map