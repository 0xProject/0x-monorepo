...
var TestFullMigrationContract = /** @class */ (function (_super) {
    __extends(TestFullMigrationContract, _super);
    function TestFullMigrationContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TestFullMigrationContract.deployedBytecode; }
        var _this = _super.call(this, 'TestFullMigration', TestFullMigrationContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        TestFullMigrationContract.ABI().forEach(function (item, index) {
    ...
    TestFullMigrationContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies, deployer) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TestFullMigrationContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, deployer)];
            });
        });
    };
    TestFullMigrationContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, deployer) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TestFullMigrationContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TestFullMigrationContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, deployer) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        txReceipt = _b.sent();
                        utils_1.logUtils.log("TestFullMigration successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TestFullMigrationContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TestFullMigrationContract.ABI = function () {
        var abi = [
            {
                inputs: [
                    {
    ...
    TestFullMigrationContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TestFullMigrationContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TestFullMigrationContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TestFullMigrationContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TestFullMigrationContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TestFullMigrationContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TestFullMigrationContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
 ...
 * transfer ownership to `owner`, then self-destruct.
     ...
     */
    TestFullMigrationContract.prototype.deploy = function (owner, features, migrateOpts) {
        var self = this;
        assert_1.assert.isString('owner', owner);
        var functionSignature = 'deploy(address,(address,address,address,address),(address))';
        return {
    ...
    ;
    TestFullMigrationContract.prototype.deployer = function () {
        var self = this;
    ...
    ;
    TestFullMigrationContract.prototype.die = function (ethRecipient) {
        var self = this;
    ...
    ;
    TestFullMigrationContract.prototype.dieRecipient = function () {
        var self = this;
    ...
    ;
    TestFullMigrationContract.contractName = 'TestFullMigration';
    return TestFullMigrationContract;
}(base_contract_1.BaseContract));
exports.TestFullMigrationContract = TestFullMigrationContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=test_full_migration.js.map