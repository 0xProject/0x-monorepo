...
var TestTransformerBaseContract = /** @class */ (function (_super) {
    __extends(TestTransformerBaseContract, _super);
    function TestTransformerBaseContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TestTransformerBaseContract.deployedBytecode; }
        var _this = _super.call(this, 'TestTransformerBase', TestTransformerBaseContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        TestTransformerBaseContract.ABI().forEach(function (item, index) {
    ...
    TestTransformerBaseContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TestTransformerBaseContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TestTransformerBaseContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TestTransformerBaseContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TestTransformerBaseContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("TestTransformerBase successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TestTransformerBaseContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TestTransformerBaseContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                name: 'deployer',
    ...
    TestTransformerBaseContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TestTransformerBaseContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TestTransformerBaseContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TestTransformerBaseContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TestTransformerBaseContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TestTransformerBaseContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TestTransformerBaseContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    TestTransformerBaseContract.prototype.deployer = function () {
        var self = this;
 ...
 * succeed in the context of a delegatecall (from another contract).
     ...
     */
    TestTransformerBaseContract.prototype.die = function (ethRecipient) {
        var self = this;
    ...
    ;
    TestTransformerBaseContract.prototype.transform = function (index_0, index_1, index_2) {
        var self = this;
    ...
    ;
    TestTransformerBaseContract.contractName = 'TestTransformerBase';
    return TestTransformerBaseContract;
}(base_contract_1.BaseContract));
exports.TestTransformerBaseContract = TestTransformerBaseContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=test_transformer_base.js.map