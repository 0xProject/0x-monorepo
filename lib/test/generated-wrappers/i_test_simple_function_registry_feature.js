...
var ITestSimpleFunctionRegistryFeatureContract = /** @class */ (function (_super) {
    __extends(ITestSimpleFunctionRegistryFeatureContract, _super);
    function ITestSimpleFunctionRegistryFeatureContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = ITestSimpleFunctionRegistryFeatureContract.deployedBytecode; }
        var _this = _super.call(this, 'ITestSimpleFunctionRegistryFeature', ITestSimpleFunctionRegistryFeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        ITestSimpleFunctionRegistryFeatureContract.ABI().forEach(function (item, index) {
    ...
    ITestSimpleFunctionRegistryFeatureContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, ITestSimpleFunctionRegistryFeatureContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    ITestSimpleFunctionRegistryFeatureContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ITestSimpleFunctionRegistryFeatureContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    ITestSimpleFunctionRegistryFeatureContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("ITestSimpleFunctionRegistryFeature successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new ITestSimpleFunctionRegistryFeatureContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    ITestSimpleFunctionRegistryFeatureContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                name: 'testFn',
    ...
    ITestSimpleFunctionRegistryFeatureContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, ITestSimpleFunctionRegistryFeatureContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    ITestSimpleFunctionRegistryFeatureContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = ITestSimpleFunctionRegistryFeatureContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    ITestSimpleFunctionRegistryFeatureContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    ITestSimpleFunctionRegistryFeatureContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    ITestSimpleFunctionRegistryFeatureContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    ITestSimpleFunctionRegistryFeatureContract.prototype.testFn = function () {
        var self = this;
    ...
    ;
    ITestSimpleFunctionRegistryFeatureContract.contractName = 'ITestSimpleFunctionRegistryFeature';
    return ITestSimpleFunctionRegistryFeatureContract;
}(base_contract_1.BaseContract));
exports.ITestSimpleFunctionRegistryFeatureContract = ITestSimpleFunctionRegistryFeatureContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_test_simple_function_registry_feature.js.map