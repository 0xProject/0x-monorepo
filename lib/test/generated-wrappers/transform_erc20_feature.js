...
var TransformERC20FeatureEvents;
(function (TransformERC20FeatureEvents) {
    TransformERC20FeatureEvents["QuoteSignerUpdated"] = "QuoteSignerUpdated";
    TransformERC20FeatureEvents["TransformedERC20"] = "TransformedERC20";
    TransformERC20FeatureEvents["TransformerDeployerUpdated"] = "TransformerDeployerUpdated";
})(TransformERC20FeatureEvents = exports.TransformERC20FeatureEvents || (exports.TransformERC20FeatureEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
class TransformERC20FeatureContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = TransformERC20FeatureContract.deployedBytecode) {
        super('TransformERC20Feature', TransformERC20FeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
        this._methodABIIndex = {};
        utils_1.classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new base_contract_1.SubscriptionManager(TransformERC20FeatureContract.ABI(), this._web3Wrapper);
        TransformERC20FeatureContract.ABI().forEach((item, index) => {
    ...
    static deployFrom0xArtifactAsync(artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return TransformERC20FeatureContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly);
        });
    }
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const libraryAddresses = yield TransformERC20FeatureContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
    ...
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.logUtils.log(`TransformERC20Feature successfully deployed at ${txReceipt.contractAddress}`);
            const contractInstance = new TransformERC20FeatureContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield TransformERC20FeatureContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = TransformERC20FeatureContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
 ...
 * to an ERC20 `outputToken`.
    ...
    ;
    /**
     * Subscribe to an event type emitted by the TransformERC20Feature contract.
     * @param eventName The TransformERC20Feature contract event you would like to subscribe to.
    ...
    subscribe(eventName, indexFilterValues, callback, isVerbose = false, blockPollingIntervalMs) {
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, TransformERC20FeatureEvents);
        ...
        const subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, TransformERC20FeatureContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
    ...
    getLogsAsync(eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
            const logs = yield this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, TransformERC20FeatureContract.ABI());
            return logs;
        });
    }
}
TransformERC20FeatureContract.contractName = 'TransformERC20Feature';
exports.TransformERC20FeatureContract = TransformERC20FeatureContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=transform_erc20_feature.js.map