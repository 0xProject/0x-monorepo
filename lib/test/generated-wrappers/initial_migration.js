...
var InitialMigrationContract = /** @class */ (function (_super) {
    __extends(InitialMigrationContract, _super);
    function InitialMigrationContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = InitialMigrationContract.deployedBytecode; }
        var _this = _super.call(this, 'InitialMigration', InitialMigrationContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        InitialMigrationContract.ABI().forEach(function (item, index) {
    ...
    InitialMigrationContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies, deployer_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, InitialMigrationContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, deployer_)];
            });
        });
    };
    InitialMigrationContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, deployer_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, InitialMigrationContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    InitialMigrationContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, deployer_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = __read(base_contract_1.BaseContract._formatABIDataItemList(constructorAbi.inputs, [deployer_
                        ], base_contract_1.BaseContract._bigNumberToString), 1), deployer_ = _a[0];
                        iface = new ethers.utils.Interface(abi);
                        deployInfo = iface.deployFunction;
                        txData = deployInfo.encode(bytecode, [deployer_
                        ]);
                    ...
                    case 3:
                        txReceipt = _b.sent();
                        utils_1.logUtils.log("InitialMigration successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new InitialMigrationContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
                        contractInstance.constructorArgs = [deployer_
                        ];
     ...
     */
    InitialMigrationContract.ABI = function () {
        var abi = [
            {
                inputs: [
                    {
    ...
    InitialMigrationContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, InitialMigrationContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    InitialMigrationContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = InitialMigrationContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    InitialMigrationContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    InitialMigrationContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    InitialMigrationContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
 ...
 * The `ZeroEx` contract will delegatecall into this function.
     ...
     */
    InitialMigrationContract.prototype.bootstrap = function (owner, features) {
        var self = this;
 ...
 * Only callable by `deployer` set in the contstructor.
      ...
      * @param features Features to bootstrap into the proxy.
     */
    InitialMigrationContract.prototype.deploy = function (owner, features) {
        var self = this;
        assert_1.assert.isString('owner', owner);
    ...
    ;
    InitialMigrationContract.prototype.deployer = function () {
        var self = this;
     ...
     */
    InitialMigrationContract.prototype.die = function (ethRecipient) {
        var self = this;
    ...
    ;
    InitialMigrationContract.contractName = 'InitialMigration';
    return InitialMigrationContract;
}(base_contract_1.BaseContract));
exports.InitialMigrationContract = InitialMigrationContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=initial_migration.js.map