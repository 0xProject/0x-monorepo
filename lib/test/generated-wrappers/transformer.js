...
var TransformerContract = /** @class */ (function (_super) {
    __extends(TransformerContract, _super);
    function TransformerContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TransformerContract.deployedBytecode; }
        var _this = _super.call(this, 'Transformer', TransformerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        TransformerContract.ABI().forEach(function (item, index) {
    ...
    TransformerContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TransformerContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TransformerContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TransformerContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TransformerContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("Transformer successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TransformerContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TransformerContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    TransformerContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TransformerContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TransformerContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TransformerContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TransformerContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TransformerContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TransformerContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    TransformerContract.prototype.deployer = function () {
        var self = this;
 ...
 * succeed in the context of a delegatecall (from another contract).
     ...
     */
    TransformerContract.prototype.die = function (ethRecipient) {
        var self = this;
    ...
    ;
    /**
     * Called from `TransformERC20.transformERC20()`. This will be
 * delegatecalled in the context of the FlashWallet instance being used.
      * @param callDataHash The hash of the `TransformERC20.transformERC20()`
     *     calldata.
      * @param taker The taker address (caller of
     *     `TransformERC20.transformERC20()`).
      * @param data Arbitrary data to pass to the transformer.
     */
    TransformerContract.prototype.transform = function (callDataHash, taker, data) {
        var self = this;
    ...
    ;
    TransformerContract.contractName = 'Transformer';
    return TransformerContract;
}(base_contract_1.BaseContract));
exports.TransformerContract = TransformerContract;
