...
var TestTransformERC20Events;
(function (TestTransformERC20Events) {
    TestTransformERC20Events["TransformedERC20"] = "TransformedERC20";
    TestTransformERC20Events["TransformerDeployerUpdated"] = "TransformerDeployerUpdated";
})(TestTransformERC20Events = exports.TestTransformERC20Events || (exports.TestTransformERC20Events = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var TestTransformERC20Contract = /** @class */ (function (_super) {
    __extends(TestTransformERC20Contract, _super);
    function TestTransformERC20Contract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TestTransformERC20Contract.deployedBytecode; }
        var _this = _super.call(this, 'TestTransformERC20', TestTransformERC20Contract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(TestTransformERC20Contract.ABI(), _this._web3Wrapper);
        TestTransformERC20Contract.ABI().forEach(function (item, index) {
    ...
    TestTransformERC20Contract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TestTransformERC20Contract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TestTransformERC20Contract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TestTransformERC20Contract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TestTransformERC20Contract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("TestTransformERC20 successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TestTransformERC20Contract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TestTransformERC20Contract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    TestTransformERC20Contract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TestTransformERC20Contract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TestTransformERC20Contract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TestTransformERC20Contract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TestTransformERC20Contract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TestTransformERC20Contract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TestTransformERC20Contract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    TestTransformERC20Contract.prototype.FEATURE_NAME = function () {
        var self = this;
        var functionSignature = 'FEATURE_NAME()';
        return {
    ...
    ;
    TestTransformERC20Contract.prototype.FEATURE_VERSION = function () {
        var self = this;
        var functionSignature = 'FEATURE_VERSION()';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    TestTransformERC20Contract.prototype._transformERC20 = function (callDataHash, taker, inputToken, outputToken, inputTokenAmount, minOutputTokenAmount, transformations) {
        var self = this;
        assert_1.assert.isString('callDataHash', callDataHash);
        ...
        var functionSignature = '_transformERC20(bytes32,address,address,address,uint256,uint256,(uint32,bytes)[])';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
            ...
            getABIEncodedTransactionData: function () {
                return self._strictEncodeArguments(functionSignature, [callDataHash,
                    taker.toLowerCase(),
 ...
 * Anyone can call this.
     */
    TestTransformERC20Contract.prototype.createTransformWallet = function () {
        var self = this;
 ...
 * context for transformations.
     */
    TestTransformERC20Contract.prototype.getTransformWallet = function () {
        var self = this;
     ...
     */
    TestTransformERC20Contract.prototype.getTransformerDeployer = function () {
        var self = this;
 ...
 * Should be delegatecalled by `Migrate.migrate()`.
     ...
     */
    TestTransformERC20Contract.prototype.migrate = function (transformerDeployer) {
        var self = this;
        assert_1.assert.isString('transformerDeployer', transformerDeployer);
        var functionSignature = 'migrate(address)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
 ...
 * Only callable by the owner.
     ...
     *     transformers.
     */
    TestTransformERC20Contract.prototype.setTransformerDeployer = function (transformerDeployer) {
        var self = this;
        assert_1.assert.isString('transformerDeployer', transformerDeployer);
 ...
 * to an ERC20 `outputToken`.
     ...
     *     balance(s)        in sequence.
     */
    TestTransformERC20Contract.prototype.transformERC20 = function (inputToken, outputToken, inputTokenAmount, minOutputTokenAmount, transformations) {
        var self = this;
        assert_1.assert.isString('inputToken', inputToken);
        assert_1.assert.isString('outputToken', outputToken);
        assert_1.assert.isBigNumber('inputTokenAmount', inputTokenAmount);
    ...
    ;
    /**
     * Subscribe to an event type emitted by the TestTransformERC20 contract.
     * @param eventName The TestTransformERC20 contract event you would like to subscribe to.
     ...
     */
    TestTransformERC20Contract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, TestTransformERC20Events);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, TestTransformERC20Contract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    TestTransformERC20Contract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    TestTransformERC20Contract.prototype.unsubscribeAll = function () {
     ...
     */
    TestTransformERC20Contract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, TestTransformERC20Contract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    TestTransformERC20Contract.contractName = 'TestTransformERC20';
    return TestTransformERC20Contract;
}(base_contract_1.BaseContract));
exports.TestTransformERC20Contract = TestTransformERC20Contract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=test_transform_erc20.js.map