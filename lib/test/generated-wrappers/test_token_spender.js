...
var TestTokenSpenderContract = /** @class */ (function (_super) {
    __extends(TestTokenSpenderContract, _super);
    function TestTokenSpenderContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TestTokenSpenderContract.deployedBytecode; }
        var _this = _super.call(this, 'TestTokenSpender', TestTokenSpenderContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        TestTokenSpenderContract.ABI().forEach(function (item, index) {
    ...
    TestTokenSpenderContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TestTokenSpenderContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TestTokenSpenderContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TestTokenSpenderContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TestTokenSpenderContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("TestTokenSpender successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TestTokenSpenderContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TestTokenSpenderContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                name: 'FEATURE_NAME',
    ...
    TestTokenSpenderContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TestTokenSpenderContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TestTokenSpenderContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TestTokenSpenderContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TestTokenSpenderContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TestTokenSpenderContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TestTokenSpenderContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    TestTokenSpenderContract.prototype.FEATURE_NAME = function () {
        var self = this;
    ...
    ;
    TestTokenSpenderContract.prototype.FEATURE_VERSION = function () {
        var self = this;
    ...
    ;
    /**
     * Transfers ERC20 tokens from `owner` to `to`. Only callable from within.
      * @param token The token to spend.
      * @param owner The owner of the tokens.
      * @param to The recipient of the tokens.
      * @param amount The amount of `token` to transfer.
     */
    TestTokenSpenderContract.prototype._spendERC20Tokens = function (token, owner, to, amount) {
        var self = this;
     ...
     */
    TestTokenSpenderContract.prototype.getAllowanceTarget = function () {
        var self = this;
 ...
 * pulled from `owner` by the token spender.
      ...
      * @param owner The owner of the tokens.
     */
    TestTokenSpenderContract.prototype.getSpendableERC20BalanceOf = function (token, owner) {
        var self = this;
        assert_1.assert.isString('token', token);
        assert_1.assert.isString('owner', owner);
    ...
    ;
    /**
     * Initialize and register this feature. Should be delegatecalled
 * into during a `Migrate.migrate()`.
     ...
     */
    TestTokenSpenderContract.prototype.migrate = function (allowanceTarget) {
        var self = this;
        assert_1.assert.isString('allowanceTarget', allowanceTarget);
        ...
        return {
            ...
            getABIEncodedTransactionData: function () {
                return self._strictEncodeArguments(functionSignature, [allowanceTarget.toLowerCase()
                ]);
            },
        };
    };
    ;
    TestTokenSpenderContract.contractName = 'TestTokenSpender';
    return TestTokenSpenderContract;
}(base_contract_1.BaseContract));
exports.TestTokenSpenderContract = TestTokenSpenderContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=test_token_spender.js.map