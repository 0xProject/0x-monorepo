...
var TestFillQuoteTransformerHostContract = /** @class */ (function (_super) {
    __extends(TestFillQuoteTransformerHostContract, _super);
    function TestFillQuoteTransformerHostContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TestFillQuoteTransformerHostContract.deployedBytecode; }
        var _this = _super.call(this, 'TestFillQuoteTransformerHost', TestFillQuoteTransformerHostContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        TestFillQuoteTransformerHostContract.ABI().forEach(function (item, index) {
    ...
    TestFillQuoteTransformerHostContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TestFillQuoteTransformerHostContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TestFillQuoteTransformerHostContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TestFillQuoteTransformerHostContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TestFillQuoteTransformerHostContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("TestFillQuoteTransformerHost successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TestFillQuoteTransformerHostContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TestFillQuoteTransformerHostContract.ABI = function () {
        var abi = [
            {
                inputs: [
                    {
    ...
    TestFillQuoteTransformerHostContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TestFillQuoteTransformerHostContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TestFillQuoteTransformerHostContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TestFillQuoteTransformerHostContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TestFillQuoteTransformerHostContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TestFillQuoteTransformerHostContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TestFillQuoteTransformerHostContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    TestFillQuoteTransformerHostContract.prototype.executeTransform = function (transformer, inputToken, inputTokenAmount, data) {
        var self = this;
        ...
        var functionSignature = 'executeTransform(address,address,uint256,bytes)';
        return {
    ...
    ;
    TestFillQuoteTransformerHostContract.prototype.rawExecuteTransform = function (transformer, callDataHash, taker, data) {
        var self = this;
        assert_1.assert.isString('transformer', transformer);
    ...
    ;
    TestFillQuoteTransformerHostContract.contractName = 'TestFillQuoteTransformerHost';
    return TestFillQuoteTransformerHostContract;
}(base_contract_1.BaseContract));
exports.TestFillQuoteTransformerHostContract = TestFillQuoteTransformerHostContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=test_fill_quote_transformer_host.js.map