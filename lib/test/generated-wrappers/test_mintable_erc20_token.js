...
var TestMintableERC20TokenContract = /** @class */ (function (_super) {
    __extends(TestMintableERC20TokenContract, _super);
    function TestMintableERC20TokenContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TestMintableERC20TokenContract.deployedBytecode; }
        var _this = _super.call(this, 'TestMintableERC20Token', TestMintableERC20TokenContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        TestMintableERC20TokenContract.ABI().forEach(function (item, index) {
    ...
    TestMintableERC20TokenContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TestMintableERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TestMintableERC20TokenContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TestMintableERC20TokenContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TestMintableERC20TokenContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("TestMintableERC20Token successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TestMintableERC20TokenContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TestMintableERC20TokenContract.ABI = function () {
        var abi = [
            {
                inputs: [
                    {
    ...
    TestMintableERC20TokenContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TestMintableERC20TokenContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TestMintableERC20TokenContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TestMintableERC20TokenContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TestMintableERC20TokenContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TestMintableERC20TokenContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TestMintableERC20TokenContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    TestMintableERC20TokenContract.prototype.allowance = function (index_0, index_1) {
        var self = this;
    ...
    ;
    TestMintableERC20TokenContract.prototype.approve = function (spender, amount) {
        var self = this;
    ...
    ;
    TestMintableERC20TokenContract.prototype.balanceOf = function (index_0) {
        var self = this;
        assert_1.assert.isString('index_0', index_0);
    ...
    ;
    TestMintableERC20TokenContract.prototype.burn = function (owner, amount) {
        var self = this;
    ...
    ;
    TestMintableERC20TokenContract.prototype.getSpendableAmount = function (owner, spender) {
        var self = this;
        assert_1.assert.isString('owner', owner);
        assert_1.assert.isString('spender', spender);
    ...
    ;
    TestMintableERC20TokenContract.prototype.mint = function (owner, amount) {
        var self = this;
        assert_1.assert.isString('owner', owner);
        assert_1.assert.isBigNumber('amount', amount);
    ...
    ;
    TestMintableERC20TokenContract.prototype.transfer = function (to, amount) {
        var self = this;
    ...
    ;
    TestMintableERC20TokenContract.prototype.transferFrom = function (from, to, amount) {
        var self = this;
    ...
    ;
    TestMintableERC20TokenContract.contractName = 'TestMintableERC20Token';
    return TestMintableERC20TokenContract;
}(base_contract_1.BaseContract));
exports.TestMintableERC20TokenContract = TestMintableERC20TokenContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=test_mintable_erc20_token.js.map