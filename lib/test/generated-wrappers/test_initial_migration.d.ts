...
export declare class TestInitialMigrationContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }, deployer: string): Promise<TestInitialMigrationContract>;
    ...
    bootstrapFeature(): ContractTxFunctionObj<string>;
    callBootstrap(zeroEx: string): ContractTxFunctionObj<void>;
    /**
...
//# sourceMappingURL=test_initial_migration.d.ts.map