...
export declare type ITransformERC20FeatureEventArgs = ITransformERC20FeatureQuoteSignerUpdatedEventArgs | ITransformERC20FeatureTransformedERC20EventArgs | ITransformERC20FeatureTransformerDeployerUpdatedEventArgs;
export declare enum ITransformERC20FeatureEvents {
...
export interface ITransformERC20FeatureQuoteSignerUpdatedEventArgs extends DecodedLogArgs {
    quoteSigner: string;
}
export interface ITransformERC20FeatureTransformedERC20EventArgs extends DecodedLogArgs {
    taker: string;
    inputToken: string;
    outputToken: string;
...
export interface ITransformERC20FeatureTransformerDeployerUpdatedEventArgs extends DecodedLogArgs {
    transformerDeployer: string;
}
export declare class ITransformERC20FeatureContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }): Promise<ITransformERC20FeatureContract>;
 ...
 * to an ERC20 `outputToken`.
     ...
     */
    subscribe<ArgsType extends ITransformERC20FeatureEventArgs>(eventName: ITransformERC20FeatureEvents, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>, isVerbose?: boolean, blockPollingIntervalMs?: number): string;
    /**
     ...
     */
    getLogsAsync<ArgsType extends ITransformERC20FeatureEventArgs>(eventName: ITransformERC20FeatureEvents, blockRange: BlockRange, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: {
        [contractName: string]: ContractAbi;
    }, deployedBytecode?: string | undefined);
}
//# sourceMappingURL=i_transform_erc20_feature.d.ts.map