...
var AllowanceTargetEvents;
(function (AllowanceTargetEvents) {
    AllowanceTargetEvents["AuthorizedAddressAdded"] = "AuthorizedAddressAdded";
    AllowanceTargetEvents["AuthorizedAddressRemoved"] = "AuthorizedAddressRemoved";
    AllowanceTargetEvents["OwnershipTransferred"] = "OwnershipTransferred";
})(AllowanceTargetEvents = exports.AllowanceTargetEvents || (exports.AllowanceTargetEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var AllowanceTargetContract = /** @class */ (function (_super) {
    __extends(AllowanceTargetContract, _super);
    function AllowanceTargetContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = AllowanceTargetContract.deployedBytecode; }
        var _this = _super.call(this, 'AllowanceTarget', AllowanceTargetContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(AllowanceTargetContract.ABI(), _this._web3Wrapper);
        AllowanceTargetContract.ABI().forEach(function (item, index) {
    ...
    AllowanceTargetContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, AllowanceTargetContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    AllowanceTargetContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, AllowanceTargetContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    AllowanceTargetContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("AllowanceTarget successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new AllowanceTargetContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    AllowanceTargetContract.ABI = function () {
        var abi = [
            {
                anonymous: false,
                inputs: [
    ...
    AllowanceTargetContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, AllowanceTargetContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    AllowanceTargetContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = AllowanceTargetContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    AllowanceTargetContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    AllowanceTargetContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    AllowanceTargetContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
     ...
     */
    AllowanceTargetContract.prototype.addAuthorizedAddress = function (target) {
        var self = this;
    ...
    ;
    AllowanceTargetContract.prototype.authorities = function (index_0) {
        var self = this;
    ...
    ;
    AllowanceTargetContract.prototype.authorized = function (index_0) {
        var self = this;
     ...
     */
    AllowanceTargetContract.prototype.executeCall = function (target, callData) {
        var self = this;
        assert_1.assert.isString('target', target);
        assert_1.assert.isString('callData', callData);
        var functionSignature = 'executeCall(address,bytes)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    AllowanceTargetContract.prototype.getAuthorizedAddresses = function () {
        var self = this;
    ...
    ;
    AllowanceTargetContract.prototype.owner = function () {
        var self = this;
     ...
     */
    AllowanceTargetContract.prototype.removeAuthorizedAddress = function (target) {
        var self = this;
        assert_1.assert.isString('target', target);
     ...
     */
    AllowanceTargetContract.prototype.removeAuthorizedAddressAtIndex = function (target, index) {
        var self = this;
        assert_1.assert.isString('target', target);
     ...
     */
    AllowanceTargetContract.prototype.transferOwnership = function (newOwner) {
        var self = this;
    ...
    ;
    /**
     * Subscribe to an event type emitted by the AllowanceTarget contract.
     * @param eventName The AllowanceTarget contract event you would like to subscribe to.
     ...
     */
    AllowanceTargetContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, AllowanceTargetEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, AllowanceTargetContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    AllowanceTargetContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    AllowanceTargetContract.prototype.unsubscribeAll = function () {
     ...
     */
    AllowanceTargetContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, AllowanceTargetContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    AllowanceTargetContract.contractName = 'AllowanceTarget';
    return AllowanceTargetContract;
}(base_contract_1.BaseContract));
exports.AllowanceTargetContract = AllowanceTargetContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=allowance_target.js.map