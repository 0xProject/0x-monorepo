...
export declare class AffiliateFeeTransformerContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }): Promise<AffiliateFeeTransformerContract>;
 ...
 * succeed in the context of a delegatecall (from another contract).
     ...
     */
    transform(index_0: string, index_1: string, data: string): ContractTxFunctionObj<string>;
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: {
        [contractName: string]: ContractAbi;
    }, deployedBytecode?: string | undefined);
}
//# sourceMappingURL=affiliate_fee_transformer.d.ts.map