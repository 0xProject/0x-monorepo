...
var TokenSpenderContract = /** @class */ (function (_super) {
    __extends(TokenSpenderContract, _super);
    function TokenSpenderContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TokenSpenderContract.deployedBytecode; }
        var _this = _super.call(this, 'TokenSpender', TokenSpenderContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        TokenSpenderContract.ABI().forEach(function (item, index) {
    ...
    TokenSpenderContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TokenSpenderContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TokenSpenderContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TokenSpenderContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TokenSpenderContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("TokenSpender successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TokenSpenderContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TokenSpenderContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    TokenSpenderContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TokenSpenderContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TokenSpenderContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TokenSpenderContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TokenSpenderContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TokenSpenderContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TokenSpenderContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    TokenSpenderContract.prototype.FEATURE_NAME = function () {
        var self = this;
    ...
    ;
    TokenSpenderContract.prototype.FEATURE_VERSION = function () {
        var self = this;
     ...
     */
    TokenSpenderContract.prototype._spendERC20Tokens = function (token, owner, to, amount) {
        var self = this;
     ...
     */
    TokenSpenderContract.prototype.getAllowanceTarget = function () {
        var self = this;
 ...
 * pulled from `owner` by the token spender.
      ...
      * @param owner The owner of the tokens.
     */
    TokenSpenderContract.prototype.getSpendableERC20BalanceOf = function (token, owner) {
        var self = this;
        assert_1.assert.isString('token', token);
        assert_1.assert.isString('owner', owner);
 ...
 * into during a `Migrate.migrate()`.
     ...
     */
    TokenSpenderContract.prototype.migrate = function (allowanceTarget) {
        var self = this;
    ...
    ;
    TokenSpenderContract.contractName = 'TokenSpender';
    return TokenSpenderContract;
}(base_contract_1.BaseContract));
exports.TokenSpenderContract = TokenSpenderContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=token_spender.js.map