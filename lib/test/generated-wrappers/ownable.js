...
var OwnableContract = /** @class */ (function (_super) {
    ...
    OwnableContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, OwnableContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    OwnableContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, OwnableContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    OwnableContract.prototype.FEATURE_NAME = function () {
        var self = this;
    ...
    ;
    OwnableContract.prototype.FEATURE_VERSION = function () {
        var self = this;
 ...
 * bootstrapping is complete.
     */
    OwnableContract.prototype.bootstrap = function () {
        var self = this;
 ...
 * Before returning, the owner will be set to `newOwner`.
     ...
     */
    OwnableContract.prototype.migrate = function (target, data, newOwner) {
        var self = this;
