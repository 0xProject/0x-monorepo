...
var IKyberNetworkContract = /** @class */ (function (_super) {
    __extends(IKyberNetworkContract, _super);
    function IKyberNetworkContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = IKyberNetworkContract.deployedBytecode; }
        var _this = _super.call(this, 'IKyberNetwork', IKyberNetworkContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        IKyberNetworkContract.ABI().forEach(function (item, index) {
    ...
    IKyberNetworkContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IKyberNetworkContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IKyberNetworkContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, IKyberNetworkContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    IKyberNetworkContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IKyberNetwork successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IKyberNetworkContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    IKyberNetworkContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
    ...
    IKyberNetworkContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, IKyberNetworkContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    IKyberNetworkContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = IKyberNetworkContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    IKyberNetworkContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    IKyberNetworkContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    IKyberNetworkContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    IKyberNetworkContract.prototype.getExpectedRate = function (fromToken, toToken, fromAmount) {
        var self = this;
        assert_1.assert.isString('fromToken', fromToken);
        assert_1.assert.isString('toToken', toToken);
        assert_1.assert.isBigNumber('fromAmount', fromAmount);
        var functionSignature = 'getExpectedRate(address,address,uint256)';
        return {
    ...
    ;
    IKyberNetworkContract.contractName = 'IKyberNetwork';
    return IKyberNetworkContract;
}(base_contract_1.BaseContract));
exports.IKyberNetworkContract = IKyberNetworkContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_kyber_network.js.map