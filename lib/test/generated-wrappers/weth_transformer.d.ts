...
export declare class WethTransformerContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }, weth_: string): Promise<WethTransformerContract>;
 ...
 * succeed in the context of a delegatecall (from another contract).
     ...
     *     wrap/umwrap.
     */
    transform(index_0: string, index_1: string, data_: string): ContractTxFunctionObj<string>;
    weth(): ContractTxFunctionObj<string>;
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: {
        [contractName: string]: ContractAbi;
    }, deployedBytecode?: string | undefined);
}
//# sourceMappingURL=weth_transformer.d.ts.map