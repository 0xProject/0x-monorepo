...
export declare type TestTransformERC20EventArgs = TestTransformERC20QuoteSignerUpdatedEventArgs | TestTransformERC20TransformedERC20EventArgs | TestTransformERC20TransformerDeployerUpdatedEventArgs;
...
export interface TestTransformERC20QuoteSignerUpdatedEventArgs extends DecodedLogArgs {
    quoteSigner: string;
}
