...
export declare type TestTransformERC20EventArgs = TestTransformERC20TransformedERC20EventArgs | TestTransformERC20TransformerDeployerUpdatedEventArgs;
export declare enum TestTransformERC20Events {
    TransformedERC20 = "TransformedERC20",
    TransformerDeployerUpdated = "TransformerDeployerUpdated"
}
export interface TestTransformERC20TransformedERC20EventArgs extends DecodedLogArgs {
    taker: string;
    inputToken: string;
    outputToken: string;
...
export interface TestTransformERC20TransformerDeployerUpdatedEventArgs extends DecodedLogArgs {
    transformerDeployer: string;
}
export declare class TestTransformERC20Contract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }): Promise<TestTransformERC20Contract>;
     ...
     */
    _transformERC20(callDataHash: string, taker: string, inputToken: string, outputToken: string, inputTokenAmount: BigNumber, minOutputTokenAmount: BigNumber, transformations: Array<{
 ...
 * to an ERC20 `outputToken`.
     ...
     */
    subscribe<ArgsType extends TestTransformERC20EventArgs>(eventName: TestTransformERC20Events, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>, isVerbose?: boolean, blockPollingIntervalMs?: number): string;
    /**
     ...
     */
    getLogsAsync<ArgsType extends TestTransformERC20EventArgs>(eventName: TestTransformERC20Events, blockRange: BlockRange, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: {
        [contractName: string]: ContractAbi;
    }, deployedBytecode?: string | undefined);
}
//# sourceMappingURL=test_transform_erc20.d.ts.map