...
export declare type MetaTransactionsEventArgs = MetaTransactionsMetaTransactionExecutedEventArgs;
export declare enum MetaTransactionsEvents {
    MetaTransactionExecuted = "MetaTransactionExecuted"
}
export interface MetaTransactionsMetaTransactionExecutedEventArgs extends DecodedLogArgs {
    hash: string;
    selector: string;
    signer: string;
    sender: string;
}
export declare class MetaTransactionsContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }, zeroExAddress: string): Promise<MetaTransactionsContract>;
 ...
 * Should be delegatecalled by `Migrate.migrate()`.
     ...
     */
    subscribe<ArgsType extends MetaTransactionsEventArgs>(eventName: MetaTransactionsEvents, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>, isVerbose?: boolean, blockPollingIntervalMs?: number): string;
    /**
     ...
     */
    getLogsAsync<ArgsType extends MetaTransactionsEventArgs>(eventName: MetaTransactionsEvents, blockRange: BlockRange, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
