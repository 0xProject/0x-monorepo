...
var ISimpleFunctionRegistryEvents;
(function (ISimpleFunctionRegistryEvents) {
    ISimpleFunctionRegistryEvents["ProxyFunctionUpdated"] = "ProxyFunctionUpdated";
})(ISimpleFunctionRegistryEvents = exports.ISimpleFunctionRegistryEvents || (exports.ISimpleFunctionRegistryEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var ISimpleFunctionRegistryContract = /** @class */ (function (_super) {
    __extends(ISimpleFunctionRegistryContract, _super);
    function ISimpleFunctionRegistryContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = ISimpleFunctionRegistryContract.deployedBytecode; }
        var _this = _super.call(this, 'ISimpleFunctionRegistry', ISimpleFunctionRegistryContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(ISimpleFunctionRegistryContract.ABI(), _this._web3Wrapper);
        ISimpleFunctionRegistryContract.ABI().forEach(function (item, index) {
    ...
    ISimpleFunctionRegistryContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, ISimpleFunctionRegistryContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    ISimpleFunctionRegistryContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ISimpleFunctionRegistryContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    ISimpleFunctionRegistryContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("ISimpleFunctionRegistry successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new ISimpleFunctionRegistryContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    ISimpleFunctionRegistryContract.ABI = function () {
        var abi = [
            {
                anonymous: false,
                inputs: [
    ...
    ISimpleFunctionRegistryContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, ISimpleFunctionRegistryContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    ISimpleFunctionRegistryContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = ISimpleFunctionRegistryContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    ISimpleFunctionRegistryContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    ISimpleFunctionRegistryContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    ISimpleFunctionRegistryContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
     ...
     */
    ISimpleFunctionRegistryContract.prototype.extend = function (selector, impl) {
        var self = this;
     ...
     */
    ISimpleFunctionRegistryContract.prototype.getRollbackEntryAtIndex = function (selector, idx) {
        var self = this;
        assert_1.assert.isString('selector', selector);
     ...
     * Retrieve the length of the rollback history for a function.
      * @param selector The function selector.
     */
    ISimpleFunctionRegistryContract.prototype.getRollbackLength = function (selector) {
        var self = this;
        assert_1.assert.isString('selector', selector);
     ...
     */
    ISimpleFunctionRegistryContract.prototype.rollback = function (selector, targetImpl) {
        var self = this;
        assert_1.assert.isString('selector', selector);
     ...
     */
    ISimpleFunctionRegistryContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, ISimpleFunctionRegistryEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, ISimpleFunctionRegistryContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    ISimpleFunctionRegistryContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    ISimpleFunctionRegistryContract.prototype.unsubscribeAll = function () {
     ...
     */
    ISimpleFunctionRegistryContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, ISimpleFunctionRegistryContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    ISimpleFunctionRegistryContract.contractName = 'ISimpleFunctionRegistry';
    return ISimpleFunctionRegistryContract;
}(base_contract_1.BaseContract));
exports.ISimpleFunctionRegistryContract = ISimpleFunctionRegistryContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_simple_function_registry.js.map