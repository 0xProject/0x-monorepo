...
var MetaTransactionsFeatureEvents;
(function (MetaTransactionsFeatureEvents) {
    MetaTransactionsFeatureEvents["MetaTransactionExecuted"] = "MetaTransactionExecuted";
})(MetaTransactionsFeatureEvents = exports.MetaTransactionsFeatureEvents || (exports.MetaTransactionsFeatureEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
class MetaTransactionsFeatureContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = MetaTransactionsFeatureContract.deployedBytecode) {
        super('MetaTransactionsFeature', MetaTransactionsFeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
        this._methodABIIndex = {};
        utils_1.classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new base_contract_1.SubscriptionManager(MetaTransactionsFeatureContract.ABI(), this._web3Wrapper);
        MetaTransactionsFeatureContract.ABI().forEach((item, index) => {
    ...
    static deployFrom0xArtifactAsync(artifact, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return MetaTransactionsFeatureContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, zeroExAddress);
        });
    }
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const libraryAddresses = yield MetaTransactionsFeatureContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
    ...
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.logUtils.log(`MetaTransactionsFeature successfully deployed at ${txReceipt.contractAddress}`);
            const contractInstance = new MetaTransactionsFeatureContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield MetaTransactionsFeatureContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = MetaTransactionsFeatureContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    MTX_EIP712_TYPEHASH() {
        const self = this;
        const functionSignature = 'MTX_EIP712_TYPEHASH()';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
 ...
 * Should be delegatecalled by `Migrate.migrate()`.
    ...
    subscribe(eventName, indexFilterValues, callback, isVerbose = false, blockPollingIntervalMs) {
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, MetaTransactionsFeatureEvents);
        ...
        const subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, MetaTransactionsFeatureContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
    ...
    getLogsAsync(eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
            const logs = yield this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, MetaTransactionsFeatureContract.ABI());
            return logs;
        });
    }
}
MetaTransactionsFeatureContract.contractName = 'MetaTransactionsFeature';
exports.MetaTransactionsFeatureContract = MetaTransactionsFeatureContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=meta_transactions_feature.js.map