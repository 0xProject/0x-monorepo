...
var DummyLiquidityProviderRegistryContract = /** @class */ (function (_super) {
    __extends(DummyLiquidityProviderRegistryContract, _super);
    function DummyLiquidityProviderRegistryContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = DummyLiquidityProviderRegistryContract.deployedBytecode; }
        var _this = _super.call(this, 'DummyLiquidityProviderRegistry', DummyLiquidityProviderRegistryContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        DummyLiquidityProviderRegistryContract.ABI().forEach(function (item, index) {
    ...
    DummyLiquidityProviderRegistryContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, DummyLiquidityProviderRegistryContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    DummyLiquidityProviderRegistryContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, DummyLiquidityProviderRegistryContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    DummyLiquidityProviderRegistryContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("DummyLiquidityProviderRegistry successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new DummyLiquidityProviderRegistryContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    DummyLiquidityProviderRegistryContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    DummyLiquidityProviderRegistryContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, DummyLiquidityProviderRegistryContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    DummyLiquidityProviderRegistryContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = DummyLiquidityProviderRegistryContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    DummyLiquidityProviderRegistryContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    DummyLiquidityProviderRegistryContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    DummyLiquidityProviderRegistryContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    * @returns Address of pool.
     */
    DummyLiquidityProviderRegistryContract.prototype.getLiquidityProviderForMarket = function (takerToken, makerToken) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        var functionSignature = 'getLiquidityProviderForMarket(address,address)';
        return {
     ...
     */
    DummyLiquidityProviderRegistryContract.prototype.setLiquidityProviderForMarket = function (takerToken, makerToken, poolAddress) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isString('poolAddress', poolAddress);
        var functionSignature = 'setLiquidityProviderForMarket(address,address,address)';
        return {
    ...
    ;
    DummyLiquidityProviderRegistryContract.contractName = 'DummyLiquidityProviderRegistry';
    return DummyLiquidityProviderRegistryContract;
}(base_contract_1.BaseContract));
exports.DummyLiquidityProviderRegistryContract = DummyLiquidityProviderRegistryContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=dummy_liquidity_provider_registry.js.map