...
var SimpleFunctionRegistryEvents;
(function (SimpleFunctionRegistryEvents) {
    SimpleFunctionRegistryEvents["ProxyFunctionUpdated"] = "ProxyFunctionUpdated";
})(SimpleFunctionRegistryEvents = exports.SimpleFunctionRegistryEvents || (exports.SimpleFunctionRegistryEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var SimpleFunctionRegistryContract = /** @class */ (function (_super) {
    __extends(SimpleFunctionRegistryContract, _super);
    function SimpleFunctionRegistryContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = SimpleFunctionRegistryContract.deployedBytecode; }
        var _this = _super.call(this, 'SimpleFunctionRegistry', SimpleFunctionRegistryContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(SimpleFunctionRegistryContract.ABI(), _this._web3Wrapper);
        SimpleFunctionRegistryContract.ABI().forEach(function (item, index) {
    ...
    SimpleFunctionRegistryContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, SimpleFunctionRegistryContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    SimpleFunctionRegistryContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, SimpleFunctionRegistryContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    SimpleFunctionRegistryContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("SimpleFunctionRegistry successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new SimpleFunctionRegistryContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    SimpleFunctionRegistryContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    SimpleFunctionRegistryContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, SimpleFunctionRegistryContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    SimpleFunctionRegistryContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = SimpleFunctionRegistryContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    SimpleFunctionRegistryContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    SimpleFunctionRegistryContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    SimpleFunctionRegistryContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    SimpleFunctionRegistryContract.prototype.FEATURE_NAME = function () {
        var self = this;
    ...
    ;
    SimpleFunctionRegistryContract.prototype.FEATURE_VERSION = function () {
        var self = this;
 ...
 * complete.
     ...
     */
    SimpleFunctionRegistryContract.prototype._extendSelf = function (selector, impl) {
        var self = this;
        assert_1.assert.isString('selector', selector);
        assert_1.assert.isString('impl', impl);
        var functionSignature = '_extendSelf(bytes4,address)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    SimpleFunctionRegistryContract.prototype.bootstrap = function () {
        var self = this;
        var functionSignature = 'bootstrap()';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
 ...
 * Only directly callable by an authority.
      ...
      * @param impl The implementation contract for the function.
     */
    SimpleFunctionRegistryContract.prototype.extend = function (selector, impl) {
        var self = this;
        assert_1.assert.isString('selector', selector);
        assert_1.assert.isString('impl', impl);
     ...
     */
    SimpleFunctionRegistryContract.prototype.getRollbackEntryAtIndex = function (selector, idx) {
        var self = this;
        assert_1.assert.isString('selector', selector);
     ...
     * Retrieve the length of the rollback history for a function.
      * @param selector The function selector.
     */
    SimpleFunctionRegistryContract.prototype.getRollbackLength = function (selector) {
        var self = this;
        assert_1.assert.isString('selector', selector);
 ...
 * Only directly callable by an authority.
     ...
     */
    SimpleFunctionRegistryContract.prototype.rollback = function (selector, targetImpl) {
        var self = this;
        assert_1.assert.isString('selector', selector);
     ...
     */
    SimpleFunctionRegistryContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, SimpleFunctionRegistryEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, SimpleFunctionRegistryContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    SimpleFunctionRegistryContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    SimpleFunctionRegistryContract.prototype.unsubscribeAll = function () {
     ...
     */
    SimpleFunctionRegistryContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, SimpleFunctionRegistryContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    SimpleFunctionRegistryContract.contractName = 'SimpleFunctionRegistry';
    return SimpleFunctionRegistryContract;
}(base_contract_1.BaseContract));
exports.SimpleFunctionRegistryContract = SimpleFunctionRegistryContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=simple_function_registry.js.map