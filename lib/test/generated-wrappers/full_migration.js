...
var FullMigrationContract = /** @class */ (function (_super) {
    __extends(FullMigrationContract, _super);
    function FullMigrationContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = FullMigrationContract.deployedBytecode; }
        var _this = _super.call(this, 'FullMigration', FullMigrationContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        FullMigrationContract.ABI().forEach(function (item, index) {
    ...
    FullMigrationContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies, deployer_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, FullMigrationContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, deployer_)];
            });
        });
    };
    FullMigrationContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, deployer_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, FullMigrationContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    FullMigrationContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, deployer_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        txReceipt = _b.sent();
                        utils_1.logUtils.log("FullMigration successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new FullMigrationContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    FullMigrationContract.ABI = function () {
        var abi = [
            {
                inputs: [
                    {
    ...
    FullMigrationContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, FullMigrationContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    FullMigrationContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = FullMigrationContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    FullMigrationContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    FullMigrationContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    FullMigrationContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
 ...
 * transfer ownership to `owner`, then self-destruct.
     ...
     */
    FullMigrationContract.prototype.deploy = function (owner, features, migrateOpts) {
        var self = this;
    ...
    ;
    FullMigrationContract.prototype.deployer = function () {
        var self = this;
     ...
     */
    FullMigrationContract.prototype.die = function (ethRecipient) {
        var self = this;
    ...
    ;
    FullMigrationContract.contractName = 'FullMigration';
    return FullMigrationContract;
}(base_contract_1.BaseContract));
exports.FullMigrationContract = FullMigrationContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=full_migration.js.map