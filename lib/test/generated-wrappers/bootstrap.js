...
var BootstrapContract = /** @class */ (function (_super) {
    __extends(BootstrapContract, _super);
    function BootstrapContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = BootstrapContract.deployedBytecode; }
        var _this = _super.call(this, 'Bootstrap', BootstrapContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        BootstrapContract.ABI().forEach(function (item, index) {
    ...
    BootstrapContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies, bootstrapCaller) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, BootstrapContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, bootstrapCaller)];
            });
        });
    };
    BootstrapContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, bootstrapCaller) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, BootstrapContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    BootstrapContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, bootstrapCaller) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = __read(base_contract_1.BaseContract._formatABIDataItemList(constructorAbi.inputs, [bootstrapCaller
                        ], base_contract_1.BaseContract._bigNumberToString), 1), bootstrapCaller = _a[0];
                        iface = new ethers.utils.Interface(abi);
                        deployInfo = iface.deployFunction;
                        txData = deployInfo.encode(bytecode, [bootstrapCaller
                        ]);
                    ...
                    case 3:
                        txReceipt = _b.sent();
                        utils_1.logUtils.log("Bootstrap successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new BootstrapContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
                        contractInstance.constructorArgs = [bootstrapCaller
                        ];
     ...
     */
    BootstrapContract.ABI = function () {
        var abi = [
            {
                inputs: [
                    {
    ...
    BootstrapContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, BootstrapContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    BootstrapContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = BootstrapContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    BootstrapContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    BootstrapContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    BootstrapContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
 ...
 * deregister itself from the proxy to prevent being called again.
     ...
     */
    BootstrapContract.prototype.bootstrap = function (target, callData) {
        var self = this;
        assert_1.assert.isString('target', target);
        assert_1.assert.isString('callData', callData);
        var functionSignature = 'bootstrap(address,bytes)';
        return {
 ...
 * Can only be called by the deployer.
     */
    BootstrapContract.prototype.die = function () {
        var self = this;
    ...
    ;
    BootstrapContract.contractName = 'Bootstrap';
    return BootstrapContract;
}(base_contract_1.BaseContract));
exports.BootstrapContract = BootstrapContract;
