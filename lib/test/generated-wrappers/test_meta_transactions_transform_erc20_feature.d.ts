...
export declare type TestMetaTransactionsTransformERC20FeatureEventArgs = TestMetaTransactionsTransformERC20FeatureQuoteSignerUpdatedEventArgs | TestMetaTransactionsTransformERC20FeatureTransformERC20CalledEventArgs | TestMetaTransactionsTransformERC20FeatureTransformedERC20EventArgs | TestMetaTransactionsTransformERC20FeatureTransformerDeployerUpdatedEventArgs;
export declare enum TestMetaTransactionsTransformERC20FeatureEvents {
    QuoteSignerUpdated = "QuoteSignerUpdated",
    TransformERC20Called = "TransformERC20Called",
    TransformedERC20 = "TransformedERC20",
    TransformerDeployerUpdated = "TransformerDeployerUpdated"
}
export interface TestMetaTransactionsTransformERC20FeatureQuoteSignerUpdatedEventArgs extends DecodedLogArgs {
    quoteSigner: string;
}
export interface TestMetaTransactionsTransformERC20FeatureTransformERC20CalledEventArgs extends DecodedLogArgs {
    sender: string;
    value: BigNumber;
    taker: string;
    inputToken: string;
...
export interface TestMetaTransactionsTransformERC20FeatureTransformedERC20EventArgs extends DecodedLogArgs {
    taker: string;
    inputToken: string;
    outputToken: string;
    inputTokenAmount: BigNumber;
...
export interface TestMetaTransactionsTransformERC20FeatureTransformerDeployerUpdatedEventArgs extends DecodedLogArgs {
    transformerDeployer: string;
}
export declare class TestMetaTransactionsTransformERC20FeatureContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }): Promise<TestMetaTransactionsTransformERC20FeatureContract>;
 ...
 * to an ERC20 `outputToken`.
     ...
     */
    subscribe<ArgsType extends TestMetaTransactionsTransformERC20FeatureEventArgs>(eventName: TestMetaTransactionsTransformERC20FeatureEvents, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>, isVerbose?: boolean, blockPollingIntervalMs?: number): string;
    /**
     ...
     */
    getLogsAsync<ArgsType extends TestMetaTransactionsTransformERC20FeatureEventArgs>(eventName: TestMetaTransactionsTransformERC20FeatureEvents, blockRange: BlockRange, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: {
        [contractName: string]: ContractAbi;
    }, deployedBytecode?: string | undefined);
}
//# sourceMappingURL=test_meta_transactions_transform_erc20_feature.d.ts.map