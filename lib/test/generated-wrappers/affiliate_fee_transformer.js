...
var AffiliateFeeTransformerContract = /** @class */ (function (_super) {
    __extends(AffiliateFeeTransformerContract, _super);
    function AffiliateFeeTransformerContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = AffiliateFeeTransformerContract.deployedBytecode; }
        var _this = _super.call(this, 'AffiliateFeeTransformer', AffiliateFeeTransformerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        AffiliateFeeTransformerContract.ABI().forEach(function (item, index) {
    ...
    AffiliateFeeTransformerContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, AffiliateFeeTransformerContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    AffiliateFeeTransformerContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, AffiliateFeeTransformerContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    AffiliateFeeTransformerContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("AffiliateFeeTransformer successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new AffiliateFeeTransformerContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    AffiliateFeeTransformerContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    AffiliateFeeTransformerContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, AffiliateFeeTransformerContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    AffiliateFeeTransformerContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = AffiliateFeeTransformerContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    AffiliateFeeTransformerContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    AffiliateFeeTransformerContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    AffiliateFeeTransformerContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    AffiliateFeeTransformerContract.prototype.deployer = function () {
        var self = this;
 ...
 * succeed in the context of a delegatecall (from another contract).
     ...
     */
    AffiliateFeeTransformerContract.prototype.die = function (ethRecipient) {
        var self = this;
     ...
     */
    AffiliateFeeTransformerContract.prototype.transform = function (index_0, index_1, data) {
        var self = this;
    ...
    ;
    AffiliateFeeTransformerContract.contractName = 'AffiliateFeeTransformer';
    return AffiliateFeeTransformerContract;
}(base_contract_1.BaseContract));
exports.AffiliateFeeTransformerContract = AffiliateFeeTransformerContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=affiliate_fee_transformer.js.map