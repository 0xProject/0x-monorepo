...
var TestWethContract = /** @class */ (function (_super) {
    __extends(TestWethContract, _super);
    function TestWethContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TestWethContract.deployedBytecode; }
        var _this = _super.call(this, 'TestWeth', TestWethContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        TestWethContract.ABI().forEach(function (item, index) {
    ...
    TestWethContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TestWethContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TestWethContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TestWethContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TestWethContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("TestWeth successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TestWethContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
    ...
    TestWethContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TestWethContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TestWethContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TestWethContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TestWethContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TestWethContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TestWethContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    TestWethContract.prototype.allowance = function (index_0, index_1) {
        var self = this;
    ...
    ;
    TestWethContract.prototype.approve = function (spender, amount) {
        var self = this;
    ...
    ;
    TestWethContract.prototype.balanceOf = function (index_0) {
        var self = this;
        assert_1.assert.isString('index_0', index_0);
    ...
    ;
    TestWethContract.prototype.burn = function (owner, amount) {
        var self = this;
    ...
    ;
    TestWethContract.prototype.deposit = function () {
        var self = this;
        var functionSignature = 'deposit()';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    TestWethContract.prototype.getSpendableAmount = function (owner, spender) {
        var self = this;
        assert_1.assert.isString('owner', owner);
        assert_1.assert.isString('spender', spender);
    ...
    ;
    TestWethContract.prototype.mint = function (owner, amount) {
        var self = this;
        assert_1.assert.isString('owner', owner);
        assert_1.assert.isBigNumber('amount', amount);
    ...
    ;
    TestWethContract.prototype.transfer = function (to, amount) {
        var self = this;
    ...
    ;
    TestWethContract.prototype.transferFrom = function (from, to, amount) {
        var self = this;
    ...
    ;
    TestWethContract.prototype.withdraw = function (amount) {
        var self = this;
        assert_1.assert.isBigNumber('amount', amount);
    ...
    ;
    TestWethContract.contractName = 'TestWeth';
    return TestWethContract;
}(base_contract_1.BaseContract));
exports.TestWethContract = TestWethContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=test_weth.js.map