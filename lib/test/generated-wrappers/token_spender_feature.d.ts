...
export declare class TokenSpenderFeatureContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }): Promise<TokenSpenderFeatureContract>;
 ...
 * into during a `Migrate.migrate()`.
     ...
     */
    migrate(allowanceTarget: string): ContractTxFunctionObj<string>;
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: {
        [contractName: string]: ContractAbi;
    }, deployedBytecode?: string | undefined);
}
//# sourceMappingURL=token_spender_feature.d.ts.map