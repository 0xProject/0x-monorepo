...
var DummyLiquidityProviderContract = /** @class */ (function (_super) {
    __extends(DummyLiquidityProviderContract, _super);
    function DummyLiquidityProviderContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = DummyLiquidityProviderContract.deployedBytecode; }
        var _this = _super.call(this, 'DummyLiquidityProvider', DummyLiquidityProviderContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        DummyLiquidityProviderContract.ABI().forEach(function (item, index) {
    ...
    DummyLiquidityProviderContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, DummyLiquidityProviderContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    DummyLiquidityProviderContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, DummyLiquidityProviderContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    DummyLiquidityProviderContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("DummyLiquidityProvider successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new DummyLiquidityProviderContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    DummyLiquidityProviderContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    DummyLiquidityProviderContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, DummyLiquidityProviderContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    DummyLiquidityProviderContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = DummyLiquidityProviderContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    DummyLiquidityProviderContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    DummyLiquidityProviderContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    DummyLiquidityProviderContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
     ...
     */
    DummyLiquidityProviderContract.prototype.getBuyQuote = function (takerToken, makerToken, buyAmount) {
        var self = this;
     ...
     */
    DummyLiquidityProviderContract.prototype.getSellQuote = function (takerToken, makerToken, sellAmount) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
    ...
    DummyLiquidityProviderContract.contractName = 'DummyLiquidityProvider';
    return DummyLiquidityProviderContract;
}(base_contract_1.BaseContract));
exports.DummyLiquidityProviderContract = DummyLiquidityProviderContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=dummy_liquidity_provider.js.map