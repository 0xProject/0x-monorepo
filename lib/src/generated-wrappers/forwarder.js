...
var ForwarderContract = /** @class */ (function (_super) {
    ...
    ForwarderContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies, _exchange, _exchangeV2, _weth) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, ForwarderContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, _exchange, _exchangeV2, _weth)];
            });
        });
    };
    ForwarderContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, _exchange, _exchangeV2, _weth) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ForwarderContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    ForwarderContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, _exchange, _exchangeV2, _weth) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = __read(base_contract_1.BaseContract._formatABIDataItemList(constructorAbi.inputs, [_exchange, _exchangeV2, _weth], base_contract_1.BaseContract._bigNumberToString), 3), _exchange = _a[0], _exchangeV2 = _a[1], _weth = _a[2];
                        iface = new ethers.utils.Interface(abi);
                        deployInfo = iface.deployFunction;
                        txData = deployInfo.encode(bytecode, [_exchange, _exchangeV2, _weth]);
    ...
    ForwarderContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, ForwarderContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    ForwarderContract.prototype.ERC1155_BATCH_RECEIVED = function () {
        var self = this;
        var functionSignature = 'ERC1155_BATCH_RECEIVED()';
        return {
    ...
    ForwarderContract.prototype.ERC1155_RECEIVED = function () {
        var self = this;
        var functionSignature = 'ERC1155_RECEIVED()';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ForwarderContract.prototype.EXCHANGE_V2_ORDER_ID = function () {
        var self = this;
        var functionSignature = 'EXCHANGE_V2_ORDER_ID()';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    ForwarderContract.prototype.marketBuyOrdersWithEth = function (orders, makerAssetBuyAmount, signatures, ethFeeAmounts, feeRecipients) {
        var self = this;
     ...
     * @returns wethSpentAmount Amount of WETH spent on the given set of orders.makerAssetAcquiredAmount Amount of maker asset acquired from the given set of orders.
     */
    ForwarderContract.prototype.marketSellOrdersWithEth = function (orders, signatures, ethFeeAmounts, feeRecipients) {
        var self = this;
        assert_1.assert.isArray('orders', orders);
        assert_1.assert.isArray('signatures', signatures);
        assert_1.assert.isArray('ethFeeAmounts', ethFeeAmounts);
     ...
     */
    ForwarderContract.prototype.onERC1155BatchReceived = function (operator, from, ids, values, data) {
        var self = this;
     ...
     */
    ForwarderContract.prototype.onERC1155Received = function (operator, from, id, value, data) {
        var self = this;
        assert_1.assert.isString('operator', operator);
        assert_1.assert.isString('from', from);
