...
export declare class DummyLiquidityProviderRegistryContract extends BaseContract {
    /**
     * @ignore
     */
     ...
     */
    setLiquidityProviderForMarket(takerToken: string, makerToken: string, poolAddress: string): ContractTxFunctionObj<void>;
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: {
        [contractName: string]: ContractAbi;
    }, deployedBytecode?: string | undefined);
}
//# sourceMappingURL=dummy_liquidity_provider_registry.d.ts.map