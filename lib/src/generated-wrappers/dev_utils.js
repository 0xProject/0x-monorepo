...
var DevUtilsContract = /** @class */ (function (_super) {
    __extends(DevUtilsContract, _super);
    function DevUtilsContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = DevUtilsContract.deployedBytecode; }
        var _this = _super.call(this, 'DevUtils', DevUtilsContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        DevUtilsContract.ABI().forEach(function (item, index) {
    ...
    DevUtilsContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies, exchange_, chaiBridge_, dydxBridge_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, DevUtilsContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, exchange_, chaiBridge_, dydxBridge_)];
            });
        });
    };
    DevUtilsContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, exchange_, chaiBridge_, dydxBridge_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, DevUtilsContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    DevUtilsContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, exchange_, chaiBridge_, dydxBridge_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = __read(base_contract_1.BaseContract._formatABIDataItemList(constructorAbi.inputs, [exchange_, chaiBridge_, dydxBridge_], base_contract_1.BaseContract._bigNumberToString), 3), exchange_ = _a[0], chaiBridge_ = _a[1], dydxBridge_ = _a[2];
                        iface = new ethers.utils.Interface(abi);
                        deployInfo = iface.deployFunction;
                        txData = deployInfo.encode(bytecode, [exchange_, chaiBridge_, dydxBridge_]);
                    ...
                    case 3:
                        ...
                        contractInstance = new DevUtilsContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
    ...
    DevUtilsContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, DevUtilsContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    DevUtilsContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = DevUtilsContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    DevUtilsContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    DevUtilsContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    DevUtilsContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    DevUtilsContract.prototype.EIP712_EXCHANGE_DOMAIN_HASH = function () {
        var self = this;
    ...
    DevUtilsContract.prototype.chaiBridgeAddress = function () {
        var self = this;
     ...
     */
    DevUtilsContract.prototype.decodeAssetProxyId = function (assetData) {
        var self = this;
     ...
     */
    DevUtilsContract.prototype.decodeERC1155AssetData = function (assetData) {
        var self = this;
        assert_1.assert.isString('assetData', assetData);
     ...
     */
    DevUtilsContract.prototype.decodeERC20AssetData = function (assetData) {
        var self = this;
        assert_1.assert.isString('assetData', assetData);
     ...
     */
    DevUtilsContract.prototype.decodeERC20BridgeAssetData = function (assetData) {
        var self = this;
        assert_1.assert.isString('assetData', assetData);
     ...
     */
    DevUtilsContract.prototype.decodeERC721AssetData = function (assetData) {
        var self = this;
        assert_1.assert.isString('assetData', assetData);
     ...
     */
    DevUtilsContract.prototype.decodeMultiAssetData = function (assetData) {
        var self = this;
        assert_1.assert.isString('assetData', assetData);
     ...
     */
    DevUtilsContract.prototype.decodeStaticCallAssetData = function (assetData) {
        var self = this;
        assert_1.assert.isString('assetData', assetData);
     ...
     */
    DevUtilsContract.prototype.decodeZeroExTransactionData = function (transactionData) {
        var self = this;
    ...
    DevUtilsContract.prototype.dydxBridgeAddress = function () {
        var self = this;
     ...
     */
    DevUtilsContract.prototype.encodeERC1155AssetData = function (tokenAddress, tokenIds, tokenValues, callbackData) {
        var self = this;
     ...
     */
    DevUtilsContract.prototype.encodeERC20AssetData = function (tokenAddress) {
        var self = this;
        assert_1.assert.isString('tokenAddress', tokenAddress);
     ...
     */
    DevUtilsContract.prototype.encodeERC721AssetData = function (tokenAddress, tokenId) {
        var self = this;
        assert_1.assert.isString('tokenAddress', tokenAddress);
     ...
     */
    DevUtilsContract.prototype.encodeMultiAssetData = function (amounts, nestedAssetData) {
        var self = this;
     ...
     * @returns AssetProxy-compliant asset data describing the set of assets.
     */
    DevUtilsContract.prototype.encodeStaticCallAssetData = function (staticCallTargetAddress, staticCallData, expectedReturnDataHash) {
        var self = this;
    ...
    DevUtilsContract.prototype.erc1155ProxyAddress = function () {
        var self = this;
    ...
    DevUtilsContract.prototype.erc20ProxyAddress = function () {
        var self = this;
    ...
    DevUtilsContract.prototype.erc721ProxyAddress = function () {
        var self = this;
    ...
    DevUtilsContract.prototype.exchangeAddress = function () {
        var self = this;
     ...
     */
    DevUtilsContract.prototype.getAssetProxyAllowance = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isString('assetData', assetData);
        var functionSignature = 'getAssetProxyAllowance(address,bytes)';
        return {
     ...
     */
    DevUtilsContract.prototype.getBalance = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isString('assetData', assetData);
        var functionSignature = 'getBalance(address,bytes)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DevUtilsContract.prototype.getBalanceAndAssetProxyAllowance = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isString('assetData', assetData);
        var functionSignature = 'getBalanceAndAssetProxyAllowance(address,bytes)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DevUtilsContract.prototype.getBatchAssetProxyAllowances = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isArray('assetData', assetData);
        var functionSignature = 'getBatchAssetProxyAllowances(address,bytes[])';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DevUtilsContract.prototype.getBatchBalances = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isArray('assetData', assetData);
        var functionSignature = 'getBatchBalances(address,bytes[])';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DevUtilsContract.prototype.getBatchBalancesAndAssetProxyAllowances = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isArray('assetData', assetData);
        var functionSignature = 'getBatchBalancesAndAssetProxyAllowances(address,bytes[])';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DevUtilsContract.prototype.getEthBalances = function (addresses) {
        var self = this;
        assert_1.assert.isArray('addresses', addresses);
        var functionSignature = 'getEthBalances(address[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    DevUtilsContract.prototype.getOrderHash = function (order, chainId, exchange) {
        var self = this;
        assert_1.assert.isBigNumber('chainId', chainId);
        assert_1.assert.isString('exchange', exchange);
        var functionSignature = 'getOrderHash((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes,bytes,bytes),uint256,address)';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DevUtilsContract.prototype.getOrderRelevantState = function (order, signature) {
        var self = this;
        assert_1.assert.isString('signature', signature);
        var functionSignature = 'getOrderRelevantState((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes,bytes,bytes),bytes)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DevUtilsContract.prototype.getOrderRelevantStates = function (orders, signatures) {
        var self = this;
        assert_1.assert.isArray('orders', orders);
        assert_1.assert.isArray('signatures', signatures);
        var functionSignature = 'getOrderRelevantStates((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes,bytes,bytes)[],bytes[])';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DevUtilsContract.prototype.getSimulatedOrderMakerTransferResults = function (order, takerAddress, takerAssetFillAmount) {
        var self = this;
     ...
     * @returns The index of the first failed transfer (or 4 if all transfers are successful).
     */
    DevUtilsContract.prototype.getSimulatedOrderTransferResults = function (order, takerAddress, takerAssetFillAmount) {
        var self = this;
        assert_1.assert.isString('takerAddress', takerAddress);
        assert_1.assert.isBigNumber('takerAssetFillAmount', takerAssetFillAmount);
     ...
     */
    DevUtilsContract.prototype.getSimulatedOrdersTransferResults = function (orders, takerAddresses, takerAssetFillAmounts) {
        var self = this;
        assert_1.assert.isArray('orders', orders);
    ...
    DevUtilsContract.prototype.getTransactionHash = function (transaction, chainId, exchange) {
        var self = this;
        assert_1.assert.isBigNumber('chainId', chainId);
        assert_1.assert.isString('exchange', exchange);
        var functionSignature = 'getTransactionHash((uint256,uint256,uint256,address,bytes),uint256,address)';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DevUtilsContract.prototype.getTransferableAssetAmount = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isString('assetData', assetData);
        var functionSignature = 'getTransferableAssetAmount(address,bytes)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DevUtilsContract.prototype.revertIfInvalidAssetData = function (assetData) {
        var self = this;
        assert_1.assert.isString('assetData', assetData);
    ...
    DevUtilsContract.prototype.staticCallProxyAddress = function () {
        var self = this;
