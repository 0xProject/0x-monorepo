 ...
 */
export declare enum ExtensionContractType {
    Forwarder = "FORWARDER",
    None = "NONE"
}
/**
...
export declare type SwapQuote = MarketBuySwapQuote | MarketSellSwapQuote;
 ...
 */
export declare enum SwapQuoteConsumerError {
 ...
 */
export declare enum SwapQuoterError {
 ...
 */
export declare enum OrderPrunerPermittedFeeTypes {
    NoFees = "NO_FEES",
