...
var IAllowanceTargetEvents;
(function (IAllowanceTargetEvents) {
    IAllowanceTargetEvents["AuthorizedAddressAdded"] = "AuthorizedAddressAdded";
    IAllowanceTargetEvents["AuthorizedAddressRemoved"] = "AuthorizedAddressRemoved";
    IAllowanceTargetEvents["OwnershipTransferred"] = "OwnershipTransferred";
})(IAllowanceTargetEvents = exports.IAllowanceTargetEvents || (exports.IAllowanceTargetEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var IAllowanceTargetContract = /** @class */ (function (_super) {
    __extends(IAllowanceTargetContract, _super);
    function IAllowanceTargetContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = IAllowanceTargetContract.deployedBytecode; }
        var _this = _super.call(this, 'IAllowanceTarget', IAllowanceTargetContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(IAllowanceTargetContract.ABI(), _this._web3Wrapper);
        IAllowanceTargetContract.ABI().forEach(function (item, index) {
    ...
    IAllowanceTargetContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IAllowanceTargetContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IAllowanceTargetContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, IAllowanceTargetContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    IAllowanceTargetContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IAllowanceTarget successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IAllowanceTargetContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    IAllowanceTargetContract.ABI = function () {
        var abi = [
            {
                anonymous: false,
                inputs: [
    ...
    IAllowanceTargetContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, IAllowanceTargetContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    IAllowanceTargetContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = IAllowanceTargetContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    IAllowanceTargetContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    IAllowanceTargetContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    IAllowanceTargetContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
     ...
     */
    IAllowanceTargetContract.prototype.addAuthorizedAddress = function (target) {
        var self = this;
     ...
     */
    IAllowanceTargetContract.prototype.authorities = function (idx) {
        var self = this;
        ...
        return {
            ...
            getABIEncodedTransactionData: function () {
                return self._strictEncodeArguments(functionSignature, [idx
                ]);
            },
        };
    };
     ...
     */
    IAllowanceTargetContract.prototype.authorized = function (addr) {
        var self = this;
     ...
     */
    IAllowanceTargetContract.prototype.executeCall = function (target, callData) {
        var self = this;
        assert_1.assert.isString('target', target);
     ...
     */
    IAllowanceTargetContract.prototype.getAuthorizedAddresses = function () {
        var self = this;
     ...
     */
    IAllowanceTargetContract.prototype.owner = function () {
        var self = this;
     ...
     */
    IAllowanceTargetContract.prototype.removeAuthorizedAddress = function (target) {
        var self = this;
        assert_1.assert.isString('target', target);
     ...
     */
    IAllowanceTargetContract.prototype.removeAuthorizedAddressAtIndex = function (target, index) {
        var self = this;
        assert_1.assert.isString('target', target);
     ...
     */
    IAllowanceTargetContract.prototype.transferOwnership = function (newOwner) {
        var self = this;
     ...
     */
    IAllowanceTargetContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, IAllowanceTargetEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, IAllowanceTargetContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    IAllowanceTargetContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    IAllowanceTargetContract.prototype.unsubscribeAll = function () {
     ...
     */
    IAllowanceTargetContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, IAllowanceTargetContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    IAllowanceTargetContract.contractName = 'IAllowanceTarget';
    return IAllowanceTargetContract;
}(base_contract_1.BaseContract));
exports.IAllowanceTargetContract = IAllowanceTargetContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_allowance_target.js.map