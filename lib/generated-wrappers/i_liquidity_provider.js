...
var ILiquidityProviderContract = /** @class */ (function (_super) {
    __extends(ILiquidityProviderContract, _super);
    function ILiquidityProviderContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = ILiquidityProviderContract.deployedBytecode; }
        var _this = _super.call(this, 'ILiquidityProvider', ILiquidityProviderContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        ILiquidityProviderContract.ABI().forEach(function (item, index) {
    ...
    ILiquidityProviderContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, ILiquidityProviderContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    ILiquidityProviderContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ILiquidityProviderContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    ILiquidityProviderContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("ILiquidityProvider successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new ILiquidityProviderContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    ILiquidityProviderContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
    ...
    ILiquidityProviderContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, ILiquidityProviderContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    ILiquidityProviderContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = ILiquidityProviderContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    ILiquidityProviderContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    ILiquidityProviderContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    ILiquidityProviderContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    * @returns success The magic bytes &#x60;0xdc1600f3&#x60; if successful.
     */
    ILiquidityProviderContract.prototype.bridgeTransferFrom = function (tokenAddress, from, to, amount, bridgeData) {
        var self = this;
        ...
        var functionSignature = 'bridgeTransferFrom(address,address,address,uint256,bytes)';
        return {
 ...
 * order to obtain `buyAmount` of `makerToken`.
    ...
    * @returns takerTokenAmount Amount of &#x60;takerToken&#x60; that would need to be sold.
     */
    ILiquidityProviderContract.prototype.getBuyQuote = function (takerToken, makerToken, buyAmount) {
        var self = this;
        ...
        var functionSignature = 'getBuyQuote(address,address,uint256)';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
 ...
 * selling `sellAmount` of `takerToken`.
    ...
    * @returns makerTokenAmount Amount of &#x60;makerToken&#x60; that would be obtained.
     */
    ILiquidityProviderContract.prototype.getSellQuote = function (takerToken, makerToken, sellAmount) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isBigNumber('sellAmount', sellAmount);
        var functionSignature = 'getSellQuote(address,address,uint256)';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    ILiquidityProviderContract.contractName = 'ILiquidityProvider';
    return ILiquidityProviderContract;
}(base_contract_1.BaseContract));
exports.ILiquidityProviderContract = ILiquidityProviderContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_liquidity_provider.js.map