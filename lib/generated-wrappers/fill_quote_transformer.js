...
var FillQuoteTransformerContract = /** @class */ (function (_super) {
    __extends(FillQuoteTransformerContract, _super);
    function FillQuoteTransformerContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = FillQuoteTransformerContract.deployedBytecode; }
        var _this = _super.call(this, 'FillQuoteTransformer', FillQuoteTransformerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        FillQuoteTransformerContract.ABI().forEach(function (item, index) {
    ...
    FillQuoteTransformerContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies, exchange_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, FillQuoteTransformerContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, exchange_)];
            });
        });
    };
    FillQuoteTransformerContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, exchange_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, FillQuoteTransformerContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    FillQuoteTransformerContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, exchange_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = __read(base_contract_1.BaseContract._formatABIDataItemList(constructorAbi.inputs, [exchange_
                        ], base_contract_1.BaseContract._bigNumberToString), 1), exchange_ = _a[0];
                        iface = new ethers.utils.Interface(abi);
                        deployInfo = iface.deployFunction;
                        txData = deployInfo.encode(bytecode, [exchange_
                        ]);
                    ...
                    case 3:
                        txReceipt = _b.sent();
                        utils_1.logUtils.log("FillQuoteTransformer successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new FillQuoteTransformerContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
                        contractInstance.constructorArgs = [exchange_
                        ];
     ...
     */
    FillQuoteTransformerContract.ABI = function () {
        var abi = [
            {
                inputs: [
                    {
    ...
    FillQuoteTransformerContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, FillQuoteTransformerContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    FillQuoteTransformerContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = FillQuoteTransformerContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    FillQuoteTransformerContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    FillQuoteTransformerContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    FillQuoteTransformerContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    FillQuoteTransformerContract.prototype.deployer = function () {
        var self = this;
 ...
 * succeed in the context of a delegatecall (from another contract).
     ...
     */
    FillQuoteTransformerContract.prototype.die = function (ethRecipient) {
        var self = this;
    ...
    ;
    FillQuoteTransformerContract.prototype.erc20Proxy = function () {
        var self = this;
        var functionSignature = 'erc20Proxy()';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    FillQuoteTransformerContract.prototype.exchange = function () {
        var self = this;
        var functionSignature = 'exchange()';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
 ...
 * to this call. `buyToken` and excess ETH will be transferred back to the caller.
     ...
     */
    FillQuoteTransformerContract.prototype.transform = function (index_0, index_1, data_) {
        var self = this;
    ...
    ;
    FillQuoteTransformerContract.contractName = 'FillQuoteTransformer';
    return FillQuoteTransformerContract;
}(base_contract_1.BaseContract));
exports.FillQuoteTransformerContract = FillQuoteTransformerContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=fill_quote_transformer.js.map