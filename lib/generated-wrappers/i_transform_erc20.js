...
var ITransformERC20Contract = /** @class */ (function (_super) {
    __extends(ITransformERC20Contract, _super);
    function ITransformERC20Contract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = ITransformERC20Contract.deployedBytecode; }
        var _this = _super.call(this, 'ITransformERC20', ITransformERC20Contract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(ITransformERC20Contract.ABI(), _this._web3Wrapper);
        ITransformERC20Contract.ABI().forEach(function (item, index) {
    ...
    ITransformERC20Contract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, ITransformERC20Contract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    ITransformERC20Contract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ITransformERC20Contract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    ITransformERC20Contract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new ITransformERC20Contract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    ITransformERC20Contract.ABI = function () {
        var abi = [
            {
                anonymous: false,
                inputs: [
    ...
    ITransformERC20Contract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, ITransformERC20Contract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    ITransformERC20Contract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = ITransformERC20Contract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    ITransformERC20Contract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    ITransformERC20Contract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    ITransformERC20Contract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
     ...
     */
    ITransformERC20Contract.prototype._transformERC20 = function (callDataHash, taker, inputToken, outputToken, inputTokenAmount, minOutputTokenAmount, transformations) {
        var self = this;
 ...
 * Anyone can call this.
     */
    ITransformERC20Contract.prototype.createTransformWallet = function () {
        var self = this;
 ...
 * context for transformations.
     */
    ITransformERC20Contract.prototype.getTransformWallet = function () {
        var self = this;
     ...
     */
    ITransformERC20Contract.prototype.getTransformerDeployer = function () {
        var self = this;
 ...
 * Only callable by the owner.
     ...
     *     transformers.
     */
    ITransformERC20Contract.prototype.setTransformerDeployer = function (transformerDeployer) {
        var self = this;
 ...
 * to an ERC20 `outputToken`.
     ...
     *     balance(s)        in sequence.
     */
    ITransformERC20Contract.prototype.transformERC20 = function (inputToken, outputToken, inputTokenAmount, minOutputTokenAmount, transformations) {
        var self = this;
        assert_1.assert.isString('inputToken', inputToken);
        assert_1.assert.isString('outputToken', outputToken);
        assert_1.assert.isBigNumber('inputTokenAmount', inputTokenAmount);
     ...
     */
    ITransformERC20Contract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, ITransformERC20Contract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    ITransformERC20Contract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    ITransformERC20Contract.prototype.unsubscribeAll = function () {
     ...
     */
    ITransformERC20Contract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, ITransformERC20Contract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    return ITransformERC20Contract;
