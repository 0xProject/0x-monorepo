...
var MetaTransactionsEvents;
(function (MetaTransactionsEvents) {
    MetaTransactionsEvents["MetaTransactionExecuted"] = "MetaTransactionExecuted";
})(MetaTransactionsEvents = exports.MetaTransactionsEvents || (exports.MetaTransactionsEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
class MetaTransactionsContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = MetaTransactionsContract.deployedBytecode) {
        super('MetaTransactions', MetaTransactionsContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
        this._methodABIIndex = {};
        utils_1.classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new base_contract_1.SubscriptionManager(MetaTransactionsContract.ABI(), this._web3Wrapper);
        MetaTransactionsContract.ABI().forEach((item, index) => {
    ...
    static deployFrom0xArtifactAsync(artifact, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return MetaTransactionsContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, zeroExAddress);
        });
    }
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const libraryAddresses = yield MetaTransactionsContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
    ...
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.logUtils.log(`MetaTransactions successfully deployed at ${txReceipt.contractAddress}`);
            const contractInstance = new MetaTransactionsContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield MetaTransactionsContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = MetaTransactionsContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
 ...
 * Should be delegatecalled by `Migrate.migrate()`.
    ...
    ;
    /**
     * Subscribe to an event type emitted by the MetaTransactions contract.
     * @param eventName The MetaTransactions contract event you would like to subscribe to.
    ...
    subscribe(eventName, indexFilterValues, callback, isVerbose = false, blockPollingIntervalMs) {
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, MetaTransactionsEvents);
        ...
        const subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, MetaTransactionsContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
    ...
    getLogsAsync(eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
            const logs = yield this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, MetaTransactionsContract.ABI());
            return logs;
        });
    }
}
MetaTransactionsContract.contractName = 'MetaTransactions';
exports.MetaTransactionsContract = MetaTransactionsContract;
