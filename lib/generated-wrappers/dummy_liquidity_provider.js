 ...
 * order to obtain `buyAmount` of `makerToken`.
    ...
    * @returns takerTokenAmount Amount of &#x60;takerToken&#x60; that would need to be sold.
     */
    DummyLiquidityProviderContract.prototype.getBuyQuote = function (index_0, index_1, buyAmount) {
        var self = this;
 ...
 * selling `sellAmount` of `takerToken`.
    ...
    * @returns makerTokenAmount Amount of &#x60;makerToken&#x60; that would be obtained.
     */
    DummyLiquidityProviderContract.prototype.getSellQuote = function (index_0, index_1, sellAmount) {
        var self = this;
        assert_1.assert.isString('index_0', index_0);
        assert_1.assert.isString('index_1', index_1);
