...
var WethTransformerContract = /** @class */ (function (_super) {
    __extends(WethTransformerContract, _super);
    function WethTransformerContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = WethTransformerContract.deployedBytecode; }
        var _this = _super.call(this, 'WethTransformer', WethTransformerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        WethTransformerContract.ABI().forEach(function (item, index) {
    ...
    WethTransformerContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies, weth_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, WethTransformerContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, weth_)];
            });
        });
    };
    WethTransformerContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, weth_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, WethTransformerContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    WethTransformerContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, weth_) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = __read(base_contract_1.BaseContract._formatABIDataItemList(constructorAbi.inputs, [weth_
                        ], base_contract_1.BaseContract._bigNumberToString), 1), weth_ = _a[0];
                        iface = new ethers.utils.Interface(abi);
                        deployInfo = iface.deployFunction;
                        txData = deployInfo.encode(bytecode, [weth_
                        ]);
                    ...
                    case 3:
                        txReceipt = _b.sent();
                        utils_1.logUtils.log("WethTransformer successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new WethTransformerContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
                        contractInstance.constructorArgs = [weth_
                        ];
     ...
     */
    WethTransformerContract.ABI = function () {
        var abi = [
            {
                inputs: [
                    {
    ...
    WethTransformerContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, WethTransformerContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    WethTransformerContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = WethTransformerContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    WethTransformerContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    WethTransformerContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    WethTransformerContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    WethTransformerContract.prototype.deployer = function () {
        var self = this;
 ...
 * succeed in the context of a delegatecall (from another contract).
     ...
     */
    WethTransformerContract.prototype.die = function (ethRecipient) {
        var self = this;
    ...
    ;
    /**
     * Wraps and unwraps WETH.
      * @param data_ ABI-encoded `TransformData`, indicating which token to
     *     wrap/umwrap.
     */
    WethTransformerContract.prototype.transform = function (index_0, index_1, data_) {
        var self = this;
    ...
    ;
    WethTransformerContract.prototype.weth = function () {
        var self = this;
        var functionSignature = 'weth()';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    WethTransformerContract.contractName = 'WethTransformer';
    return WethTransformerContract;
}(base_contract_1.BaseContract));
exports.WethTransformerContract = WethTransformerContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=weth_transformer.js.map